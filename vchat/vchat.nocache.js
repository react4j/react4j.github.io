...
vchat();(function () {var $gwt_version = "2.9.0";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {$wnd.__gwtStatsEvent(a)} : null;var $strongName = 'B0E199FB8A4B5C8773D9B100710A8F97';function t(){}
function Bh(){}
function xh(){}
function Kb(){}
function Qc(){}
...
function Nk(a,b){a.wb(b);return a}
...
function mk(a,b){while(a.Ub(b));}
function Tk(a,b,c){b.U(a.g.vb(c))}
...
function Ji(a){return !a?null:a.Qb()}
...
function Wi(a){a.j.Mb(a.i);a.h=a.i;a.i=-1}
...
function It(a,b,c){a.enabled=!a.enabled}
...
function Ui(a){a.i.Ib();a.i=null;a.h=Si(a)}
...
function lj(a){aj(this);cl(this.g,0,a.Db())}
...
function Tj(a,b){while(a.Gb()){Zk(b,a.Hb())}}
...
function ad(a){return Array.isArray(a)&&a.bc===Bh}
function hd(a){return !Array.isArray(a)&&a.bc===Bh}
...
function tk(a){if(!a.j){a.j=a.h.ub();a.i=a.h.Ab()}}
...
function Yi(a,b){this.g=a;Xi.call(this,a);a.Ab();this.h=b}
...
function Ti(a){var b;a.i=a.g;b=a.g.Hb();a.h=Si(a);return b}
...
function Qi(a,b){if(jd(b,42)){return Hi(a.g,b)}return false}
function ei(a){if(a.sb()){return null}var b=a.u;return th[b]}
function ec(a,b){Ub=new dc(Ub,b);a.j=false;Vb(Ub);return Ub}
function rc(a,b){var c;c=Zh(a._b);return b==null?c:c+': '+b}
function Ii(a,b){return b===a?'(this Map)':b==null?Ls:Ah(b)}
function an(a,b){return b.onended=yh(xp.prototype.bb,xp,[a])}
function Lr(){Lr=xh;var a;Kr=(a=yh(Jr.prototype.$b,Jr,[]),a)}
function Pr(){Pr=xh;var a;Or=(a=yh(Nr.prototype.$b,Nr,[]),a)}
function Tr(){Tr=xh;var a;Sr=(a=yh(Rr.prototype.$b,Rr,[]),a)}
function Xr(){Xr=xh;var a;Wr=(a=yh(Vr.prototype.$b,Vr,[]),a)}
...
function di(a,b){var c=a.g=a.g||[];return c[b]||(c[b]=a.nb(b))}
function pi(a,b){var c,d;for(d=a.ub();d.Gb();){c=d.Hb();b.U(c)}}
...
function Ik(a,b){return !(Bk(a),Kk(new Mk(a,new Rk(b,a.g)))).Ub(Dk)}
...
function Uk(a,b){ok.call(this,b.Tb(),b.Sb()&-6);this.g=a;this.h=b}
...
function Rk(a,b){ok.call(this,b.Tb(),b.Sb()&-16449);this.g=a;this.i=b}
...
function Jk(a,b){var c;Ak(a);c=new Xk;c.g=b;a.g.Fb(new $k(c));return c.g}
function Lk(a,b){var c;c=Fk(a,new zk(new yk));return c.Eb(b.Vb(c.Ab()))}
...
function cd(a,b){Zc(b)!=10&&bd(v(b),b.ac,b.__elementTypeId$,Zc(b),a);return a}
...
function _b(a,b){var c;if(!a.i){c=Yb(a);!c.i&&(c.i=new kj);a.i=c.i}b.j=true;a.i.wb(b)}
function hi(a,b){var c;if(!a){return}b.u=a;var d=ei(b);if(!d){th[a]=[b];return}d._b=b}
...
function mo(a,b){var c;c=b.track;a.J=Fk(Gk(a.J.Cb(),new xq(c)),new zk(new yk));Z(a.h)}
...
function md(a){return a!=null&&(typeof a===Cs||typeof a==='function')&&!(a.bc===Bh)}
...
function Gi(a,b){var c,d;for(d=b.ub();d.Gb();){c=d.Hb();if(!a.yb(c)){return false}}return true}
function pj(a){var b,c,d;d=0;for(c=a.ub();c.Gb();){b=c.Hb();d=d+(b!=null?w(b):0);d=d|0}return d}
function qj(a){var b,c,d;d=1;for(c=a.ub();c.Gb();){b=c.Hb();d=31*d+(b!=null?w(b):0);d=d|0}return d}
function mh(a){var b;if(jd(a,7)){return a}b=a&&a.__java$exception;if(!b){b=new yc(a);Vc(b)}return b}
function Si(a){if(a.g.Gb()){return true}if(a.g!=a.j){return false}a.g=new Cj(a.l.g);return a.g.Gb()}
function cj(a,b){var c,d;c=b.Db();d=c.length;if(d==0){return false}cl(a.g,a.g.length,c);return true}
...
function Qn(a,b){if(null!=a.D){b.getTracks().forEach(yh(nq.prototype.gb,nq,[a,b]));a.G=true;go(a)}}
function fn(a,b){vn(a,false);zn(a,b);b.getTracks().forEach(yh(wp.prototype.gb,wp,[a]));a.J.U(b)}
...
function jn(a){var b;b=(kb(a.o),a.D);null!=b&&b.getAudioTracks().forEach(yh(sp.prototype.hb,sp,[]));Z(a.g)}
...
function bd(a,b,c,d,e){e._b=a;e.ac=b;e.bc=Bh;e.__elementTypeId$=c;e.__elementTypeCategory$=d;return e}
function wj(a,b){var c,d,e,f;for(d=b,e=0,f=d.length;e<f;++e){c=d[e];if(rj(a,c.Pb())){return c}}return null}
...
function v(a){return od(a)?le:ld(a)?_d:kd(a)?Zd:hd(a)?a._b:ad(a)?a._b:a._b||Array.isArray(a)&&Yc(Rd,1)||Rd}
function tn(a){var b;return Wh(),b=(kb(a.o),a.D),null!=b&&b.getAudioTracks().some(yh(rp.prototype.eb,rp,[]))?true:false}
function kn(a){var b;An(a,(kb(a.u),!a.G));b=(kb(a.o),a.D);null!=b&&b.getVideoTracks().forEach(yh(tp.prototype.hb,tp,[]))}
function $m(a,b,c){a.K==b?F((O(),O(),N),new Nn(a,c),Zs):c.getTracks().forEach(yh(zp.prototype.gb,zp,[]));return null}
function Fr(a,b){var c;c=a.h.props;if(!(c['b']===b['b'])){return true}if(!(c['c']===b['c'])){return true}return false}
function Ah(a){var b;if(Array.isArray(a)&&a.bc===Bh){return Zh(v(a))+'@'+(b=w(a)>>>0,b.toString(16))}return a.toString()}
...
function Fi(a,b,c){var d,e;for(e=a.ub();e.Gb();){d=e.Hb();if(pd(b)===pd(d)||b!=null&&u(b,d)){c&&e.Ib();return true}}return false}
function Xj(a,b){var c,d;if(b>=a.h>>1){d=a.i;for(c=a.h;c>b;--c){d=d.h}}else{d=a.g.g;for(c=0;c<b;++c){d=d.g}}return new bk(a,b,d)}
function $b(a){var b;if(a.i){while(!a.i.zb()){b=a.i.Mb(a.i.Ab()-1);b.j=false;b.i.g.length>0||(b.h.i&7)>3&&xb(b.h,3,true)}}}
function Tn(a,b){var c;c=a.D.getSenders().find(yh(pq.prototype.fb,pq,[b]));if(null!=c){a.D.removeTrack(c);a.G=true;go(a)}}
function dn(a){var b;++a.K;b=a.K;Zm(a);vn(a,true);a.I.Wb().then(yh(up.prototype.jb,up,[a,b])).catch(yh(vp.prototype.kb,vp,[a,b]))}
function no(a,b){var c;if(pd(a.D)===pd(b.currentTarget)){c=b.streams;a.J=new lj(a.J);c.forEach(yh(tq.prototype.gb,tq,[a]));Z(a.h)}}
...
function gn(a){var b;b=(kb(a.o),a.D);Zm(a);F((O(),O(),N),new Jn(a,false),Zs);null!=b&&b.getTracks().forEach(yh(yp.prototype.gb,yp,[]))}
...
function jc(a){var b,c,d;for(c=new mj(new lj(new Ri(a.l)));c.g<c.i.g.length;){b=(c.h=c.g++,c.i.g[c.h]);d=b.Pb();jd(d,10)&&d.T()||b.Qb().Q()}}
...
function gd(a,b){if(od(a)){return !!fd[b]}else if(a.ac){return !!a.ac[b]}else if(ld(a)){return !!ed[b]}else if(kd(a)){return !!dd[b]}return false}
...
function en(a,b){var c;pn(a,b);c=(kb(a.o),a.D);if(b){null==c&&dn(a)}else{if(null!=c){c.getTracks().forEach(yh(zp.prototype.gb,zp,[]));zn(a,null)}}}
function Xn(a,b){var c,d;if(Ik(a.J.Cb(),new uq(b))){c=new vq;d=new En(new wq(b),c,true);dn(d);a.J.wb(d);b.onremovetrack=yh(Dp.prototype.ib,Dp,[a])}}
...
function to(a){var b;b=rn(a.K);null!=a.D&&null!=b&&sn(a.K)&&null!=a.D&&b.getTracks().forEach(yh(oq.prototype.gb,oq,[a]));Cn(a.K);null!=a.D&&sn(a.K)&&null!=b&&Qn(a,b)}
...
function io(a,b){var c;if(pd(a.D)===pd(b.currentTarget)){c=a.D.iceConnectionState;if(s('disconnected',c)||s('failed',c)||s('closed',c)){a.J.tb(new Cp);a.J=new kj;Z(a.h)}else{fo(a)}}}
...
function co(a,b){if(null!=a.L){a.I.g=$c(ie,Es,1,0,5,1);a.L.close();a.L=null;Wo(a,b)}if(null!=a.D){a.J.tb(new Ep);a.J.xb();Oi(a.H.g);a.D.close();a.D=null;a.F=false;a.G=false;jb(a.i);Z(a.h)}}
...
!Date.now&&(Date.now=b)}
function Sc(b,c){var d,e,f,g;for(e=0,f=b.length;e<f;e++){g=b[e];try{g[1]?g[0].cc()&&(c=Rc(c,g)):g[0].cc()}catch(a){a=mh(a);if(jd(a,7)){d=a;Dc();Jc(jd(d,46)?d.$():d)}else throw nh(a)}}return c}
...
function zj(a,b,c){var d,e,f,g,h;h=b==null?0:(g=w(b),g|0);e=(d=a.g.get(h),d==null?new Array:d);if(e.length==0){a.g.set(h,e)}else{f=wj(b,e);if(f){return f.Rb(c)}}e[e.length]=new _i(b,c);++a.h;return null}
...
function fo(a){var b;if(!a.F){b=(lb(a.m),a.u);if((Zp(),Xp)==b){a.F=true;a.D.createOffer().then(yh(qq.prototype.jb,qq,[a])).then(yh(rq.prototype.jb,rq,[a])).catch(yh(sq.prototype.kb,sq,[a]))}else{ro(a,rl(Ms,at))}}}
...
function Hi(a,b){var c,d,e;c=b.Pb();e=b.Qb();d=od(c)?c==null?Ji(yj(a.g,null)):Mj(a.h,c):Ji(yj(a.g,c));if(!(pd(e)===pd(d)||e!=null&&u(e,d))){return false}if(d==null&&!(od(c)?Li(a,c):!!yj(a.g,c))){return false}return true}
...
function Aj(a,b){var c,d,e,f,g,h;g=b==null?0:(f=w(b),f|0);d=(c=a.g.get(g),c==null?new Array:c);for(h=0;h<d.length;h++){e=d[h];if(rj(b,e.Pb())){if(d.length==1){d.length=0;Dj(a.g,g)}else{d.splice(h,1)}--a.h;return e.Qb()}}return null}
...
function wh(a,b,c){var d=th,h;var e=d[a];var f=e instanceof Array?e[0]:null;if(e&&!f){_=e}else{_=(h=b&&b.prototype,!h&&(h=th[b]),zh(h));_.ac=c;!b&&(_.bc=Bh);d[a]=_}for(var g=3;g<arguments.length;++g){arguments[g].prototype=_}f&&(_._b=f)}
function Al(a,b,c){var d,e,f;d={};e=null;f=null;if(null!=b){e='key' in b?b['key']:null;f='ref' in b?b['ref']:null;ql(b,yh(Dl.prototype.Xb,Dl,[d,b]))}null!=c&&c.length>0&&(1==c.length?(d[Ws]=c[0],undefined):(d[Ws]=c,undefined));return xl(a,e,f,d)}
function fi(a){if(a.rb()){var b=a.i;b.sb()?(a.v='['+b.u):!b.rb()?(a.v='[L'+b.pb()+';'):(a.v='['+b.pb());a.h=b.ob()+'[]';a.s=b.qb()+'[]';return}var c=a.m;var d=a.j;d=d.split('/');a.v=gi('.',[c,gi('$',d)]);a.h=gi('.',[c,gi('.',d)]);a.s=d[d.length-1]}
...
function so(a){a.D=new $wnd.RTCPeerConnection(Oh({},[Rh({})]));a.F=false;a.G=false;a.D.onicecandidate=yh(Mp.prototype.lb,Mp,[a]);a.D.ontrack=yh(Np.prototype.mb,Np,[a]);a.D.onconnectionstatechange=yh(Bp.prototype.bb,Bp,[a]);a.D.onnegotiationneeded=yh(mq.prototype.bb,mq,[a]);eo(a,rn(a.B));eo(a,rn(a.K))}
...
function rr(a){var b,c,d,e;a.m=0;Em();b=(c=(lb(a.h),a.i),d=a.o,e=(kb(d.g),d.i),Al(jt,Nl(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['home'])),yh(ps.prototype.Yb,ps,[a])),[Al('h1',null,['vChat']),Al('label',Zl(new $wnd.Object,'roomCode'),['Enter a room code.']),Al('input',Il(Rl(Wl(Sl(Ul(Tl(Yl(Fl(Vl(El(Ml(new $wnd.Object,(Am(),wm)),bd(Yc(le,1),Es,2,6,['roomCodeInput'])),'Room code'),'roomCode'),null==c?'':c),yh(rs.prototype.Yb,rs,[a]))),10)))),null),Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['roomSelectButtons'])),[Al(Xs,Ml(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),(bm(),am)),['Join']),Al('a',Jl(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),'#'+Hm()),['Join Random'])]),e.h==0?null:wl([Al(pt,null,['Recently used rooms:']),wl(Lk(Hk(new Mk(null,new uk(e,16)),new qs),new Cl))])]));return b}
...
function lo(a,b){var c,d,e,f,g,h;d=b.data;g=$wnd.JSON.parse(d);f=g;if(pd(a.L)===pd(b.currentTarget)){Z(a.g);c=f[Ms];if(s('create',c)){Dh(bd(Yc(ie,1),Es,1,5,['Connected to room as host']));Vo(a,(Zp(),Xp));Wo(a,(jq(),eq))}else if(s('connect',c)){Dh(bd(Yc(ie,1),Es,1,5,['Connected to room as guest']));Vo(a,(Zp(),Wp));Wo(a,(jq(),bq))}else if(s('full',c)){Dh(bd(Yc(ie,1),Es,1,5,['Room full. Leaving room.']));Vo(a,(Zp(),Yp));co(a,(jq(),dq))}else if(s(dt,c)){e=f['id'];h=f['message'];Dh(bd(Yc(ie,1),Es,1,5,["Guest '"+e+"' requested access to room with message '"+h+"'"]));bj(a.I,new Gm(e,h));jb(a.j)}else if(s('accept',c)){Dh(bd(Yc(ie,1),Es,1,5,['Host allowed guest to join room.']));Wo(a,(jq(),eq));so(a)}else if(s('reject',c)){Dh(bd(Yc(ie,1),Es,1,5,['Host rejected guest from room.']));Wo(a,(jq(),fq))}else if(s('accepted',c)){e=f['id'];Dh(bd(Yc(ie,1),Es,1,5,["Host accepted guest '"+e+"' into room."]));tj(a.H,e);jb(a.i)}else if(s('remove',c)){e=f['id'];if(uj(a.H,e)){Dh(bd(Yc(ie,1),Es,1,5,["Guest '"+e+et]));jb(a.i)}else if(ij(a.I,new yq(e))){Dh(bd(Yc(ie,1),Es,1,5,["Client '"+e+et]));jb(a.j)}}else if(s('offer',c)){a.F=true;a.D.setRemoteDescription(f[_s]);a.D.createAnswer().then(yh(zq.prototype.jb,zq,[a])).then(yh(Aq.prototype.jb,Aq,[a])).catch(yh(Bq.prototype.kb,Bq,[a]))}else if(s('answer',c)){a.D.setRemoteDescription(f[_s]);a.F=false;go(a)}else s(bt,c)?a.D.addIceCandidate(Ph(Qh({},f[ct]),f[bt])):s(at,c)&&(a.G=true,go(a))}}
function $q(a){var b,c,d;a.l=0;Em();b=(c=a.u.B,d=X(a.u.g),Al(pt,Hl(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['room-view'])),yh(bs.prototype.U,bs,[a])),[Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['video-section'])),[Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['video-list'])),Lk(Hk(X(a.u.h).Cb(),new Zr),new Cl)),Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['active-video'])),[Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['active-video-wrapper'])),[zs(xs(ws(a.u.B),'active-video-element'),true)]),Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['controls'])),[Al(Xs,Ll(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[rt])),yh(fs.prototype.Zb,fs,[a])),[Al(st,Ol(Ql(Pl(new $wnd.Object,sn(a.u.K)?'img/screen_share_on.svg':'img/screen_share_off.svg'),32),32),null)]),Al(Xs,Ll(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[rt])),yh(gs.prototype.Zb,gs,[c])),[Al(st,Ol(Ql(Pl(new $wnd.Object,X(c.g)?tt:ut),32),32),null)]),Al(Xs,Ll(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[rt])),yh(hs.prototype.Zb,hs,[c])),[Al(st,Ol(Ql(Pl(new $wnd.Object,(kb(c.u),c.G?'img/cam_on.svg':'img/cam_off.svg')),32),32),null)]),Al(Xs,Ll(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[rt])),yh(is.prototype.Zb,is,[a])),[Al(st,Ol(Ql(Pl(new $wnd.Object,X(a.g)?'img/fullscreen_on.svg':'img/fullscreen_off.svg'),32),32),null)]),Al(Xs,Ll(El(Kl(new $wnd.Object,(Tp(),Qp)!=d&&Sp!=d),bd(Yc(le,1),Es,2,6,[rt])),yh(js.prototype.Zb,js,[a])),[Al(st,Ol(Ql(Pl(new $wnd.Object,'img/hangup.svg'),32),32),null)])])])]),Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['message-area'])),[Xq(a)])]));return b}
function Xq(a){var b,c;c=Xo(a.u);if((jq(),iq)==c){return wl([Al(it,null,['Getting ready...']),Al('p',null,["You'll be able to join in just a moment."])])}else if(cq==c){return wl([Al(it,null,['Service Offline']),Al('p',null,['The chat service is offline at the moment. Try again later.'])])}else if(bq==c){return wl([Al(it,null,['Ready to join?']),Al('p',null,['Request access to join the room.']),Al(jt,Nl(new $wnd.Object,yh(_r.prototype.Yb,_r,[a])),[Al('label',Zl(new $wnd.Object,kt),[lt]),Al('input',Wl(Sl(Yl(Tl(Rl(Fl(Vl(Ml(new $wnd.Object,(Am(),wm)),mt),kt)),yh(es.prototype.Yb,es,[a])),To(a.u)),30)),null),Al(Xs,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),[ot])])])}else if(gq==c){return wl([Al(it,null,['Joining room']),Al('p',null,['Waiting for host to allow access to the room.'])])}else if(eq==c&&(Zp(),Xp)==Uo(a.u)&&Do(a.u).g.length!=0){b=Do(a.u).g[0];return wl([Al(it,null,['Guest requests access']),Al('p',null,['A guest has sent you a message to join the room:']),Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['request-message'])),[b.h]),Al(jt,Nl(new $wnd.Object,yh($r.prototype.Yb,$r,[])),[Al(Xs,Ll(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),yh(cs.prototype.Zb,cs,[a,b])),['Accept']),Al(Xs,Ll(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),yh(ds.prototype.Zb,ds,[a,b])),['Reject'])])])}else return eq==c&&(Zp(),Xp)==Uo(a.u)&&Pi(Co(a.u).g)==0?wl([Al(it,null,['Waiting for guests to join']),Al('p',null,['Waiting for someone to join this room']),Al('a',Jl(new $wnd.Object,'#'+a.u.C),[a.u.C])]):eq==c?wl([Al(it,null,['Joined room']),Al('p',null,['Joined room. Feel free to chat.'])]):fq==c?wl([Al(it,null,['Access denied']),Al('p',null,['The host denied access to the room. You can attempt to re-request access to join the room.']),Al(jt,Nl(new $wnd.Object,yh(_r.prototype.Yb,_r,[a])),[Al('label',Zl(new $wnd.Object,kt),[lt]),Al('input',Wl(Sl(Yl(Tl(Rl(Fl(Vl(Ml(new $wnd.Object,(Am(),wm)),mt),kt)),yh(es.prototype.Yb,es,[a])),To(a.u)),30)),null),Al(Xs,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),[ot])])]):aq==c?wl([Al(it,null,['Room closed']),Al('p',null,[(Zp(),Xp)==Uo(a.u)?'You closed the room.':'The host closed the room.']),Al('a',Jl(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),'#'),[qt])]):dq==c?wl([Al(it,null,['Room full']),Al('p',null,['The room is full and no other guests can connect at this time.']),Al('a',Jl(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),'#'),[qt])]):hq==c?wl([Al(it,null,['Left the room']),Al('p',null,['You left the room.']),Al('a',Jl(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,[nt])),'#'),[qt])]):null}
var Cs='object',Ds={5:1},Es={3:1},Fs={10:1},Gs=1048576,Hs=1835008,Is=2097152,Js='__noinit__',Ks={3:1,12:1,9:1,7:1},Ls='null',Ms='command',Ns='hashchange',Os={30:1,68:1},Ps={30:1,62:1},Qs={42:1},Rs={3:1,30:1,62:1},Ss='delete',Ts=15525485,Us=5.9604644775390625E-8,Vs=16777216,Ws='children',Xs='button',Ys='vchat.rooms',Zs=142606336,$s=35651584,_s='session',at='renegotiate',bt='candidate',ct='mlineindex',dt='request_access',et="' left the room.",ft=75497472,gt=1411518464,ht='fullscreenchange',it='h2',jt='form',kt='requestAccessMessage',lt='Enter a message to send to the host to request access.',mt="Hi, I'm John Doe.",nt='primary-button',ot='Request Access',pt='div',qt='Return to Home',rt='control-btn',st='img',tt='img/mic_on.svg',ut='img/mic_off.svg';var _,th,oh,lh=-1;$wnd.goog=$wnd.goog||{};$wnd.goog.global=$wnd.goog.global||$wnd;uh();wh(1,null,{},t);_.M=function(a){return s(this,a)};_.N=function(){return this._b};_.O=wt;_.P=function(){var a;return Zh(v(this))+'@'+(a=w(this)>>>0,a.toString(16))};_.equals=function(a){return this.M(a)};_.hashCode=function(){return this.O()};_.toString=function(){return this.P()};var dd,ed,fd;wh(70,1,{},$h);_.nb=function(a){var b;b=new $h;b.l=4;a>1?(b.i=di(this,a-1)):(b.i=this);return b};_.ob=function(){Yh(this);return this.h};_.pb=function(){return Zh(this)};_.qb=function(){Yh(this);return this.s};_.rb=function(){return (this.l&4)!=0};_.sb=function(){return (this.l&1)!=0};_.P=function(){return ((this.l&2)!=0?'interface ':(this.l&1)!=0?'':'class ')+(Yh(this),this.v)};_.l=0;_.o=0;var Xh=1;var ie=ai(1);var $d=ai(70);wh(102,1,{},J);_.h=1;_.i=false;_.j=true;_.l=0;var xd=ai(102);wh(103,1,Ds,K);_.Q=function(){Hb(this.g)};var ud=ai(103);wh(56,1,{},L);_.R=function(){return this.g.Q(),null};var vd=ai(56);wh(104,1,{},M);var wd=ai(104);var N;wh(57,1,{57:1},U);_.h=0;_.i=false;_.j=0;var yd=ai(57);wh(258,1,Fs);_.P=function(){var a;return Zh(this._b)+'@'+(a=w(this)>>>0,a.toString(16))};var Bd=ai(258);wh(37,258,Fs,ab);_.S=function(){W(this)};_.T=vt;_.g=false;_.j=0;_.u=false;var Ad=ai(37);wh(141,1,{},bb);_.R=function(){return Y(this.g)};var zd=ai(141);wh(11,258,{10:1,11:1},nb);_.S=function(){eb(this)};_.T=function(){return -2==this.l};_.g=4;_.j=false;_.l=0;var Dd=ai(11);wh(140,1,Ds,ob);_.Q=function(){fb(this.g)};var Cd=ai(140);wh(23,258,{10:1,23:1},Ab,Bb);_.S=function(){pb(this)};_.T=function(){return 1==(this.i&7)};_.i=0;var Id=ai(23);wh(135,1,{},Cb);_.Q=function(){V(this.g)};var Ed=ai(135);wh(136,1,Ds,Db);_.Q=function(){rb(this.g)};var Fd=ai(136);wh(137,1,Ds,Eb);_.Q=function(){ub(this.g)};var Gd=ai(137);wh(138,1,{},Fb);_.U=function(a){sb(this.g,a)};var Hd=ai(138);wh(115,1,{},Ib);_.g=0;_.h=0;_.i=0;var Jd=ai(115);wh(146,1,Fs,Kb);_.S=function(){Jb(this)};_.T=vt;_.g=false;var Kd=ai(146);wh(81,258,{10:1,81:1},Ob);_.S=function(){Lb(this)};_.T=function(){return 2==(3&this.g)};_.g=0;var Md=ai(81);wh(114,1,{},Tb);var Ld=ai(114);wh(147,1,{},dc);_.P=function(){var a;return Yh(Nd),Nd.v+'@'+(a=hl(this)>>>0,a.toString(16))};_.g=0;var Ub;var Nd=ai(147);wh(22,1,Fs,mc);_.S=function(){hc(this)};_.T=function(){return this.s<0};_.P=function(){var a;return Yh(Pd),Pd.v+'@'+(a=hl(this)>>>0,a.toString(16))};_.j=0;_.s=0;var Pd=ai(22);wh(134,1,Ds,nc);_.Q=function(){kc(this.g)};var Od=ai(134);wh(7,1,{3:1,7:1});_.V=Et;_.W=function(){return Lk(Hk(oj((this.s==null&&(this.s=$c(ne,Es,7,0,0,1)),this.s)),new Ci),new Pk)};_.X=function(){return this.m};_.Y=function(){return this.o};_.Z=function(){qc(this,sc(new Error(rc(this,this.o))));Vc(this)};_.P=function(){return rc(this,this.Y())};_.l=Js;_.u=true;var ne=ai(7);wh(12,7,{3:1,12:1,7:1});var be=ai(12);wh(9,12,Ks);var je=ai(9);wh(97,9,Ks);var ge=ai(97);wh(98,97,Ks);var Td=ai(98);wh(46,98,{46:1,3:1,12:1,9:1,7:1},yc);_.Y=function(){xc(this);return this.i};_.$=function(){return pd(this.h)===pd(vc)?null:this.h};var vc;var Qd=ai(46);var Rd=ai(0);wh(241,1,{});var Sd=ai(241);var Ac=0,Bc=0,Cc=-1;wh(107,241,{},Qc);var Mc;var Ud=ai(107);var Tc;wh(252,1,{});var Wd=ai(252);wh(99,252,{},Xc);var Vd=ai(99);wh(72,1,{95:1});_.P=vt;var Xd=ai(72);wh(101,9,Ks);var ee=ai(101);wh(139,101,Ks,Vh);var Yd=ai(139);dd={3:1,96:1,21:1};var Zd=ai(96);wh(55,1,{3:1,55:1});var he=ai(55);ed={3:1,21:1,55:1};var _d=ai(251);wh(15,1,{3:1,21:1,15:1});_.M=function(a){return this===a};_.O=wt;_.P=function(){return this.g!=null?this.g:''+this.h};_.h=0;var ae=ai(15);wh(71,9,Ks,ji);var ce=ai(71);wh(100,9,Ks,ki);var de=ai(100);wh(35,55,{3:1,21:1,35:1,55:1},li);_.M=function(a){return jd(a,35)&&a.g==this.g};_.O=vt;_.P=function(){return ''+this.g};_.g=0;var fe=ai(35);var ni;wh(355,1,{});fd={3:1,95:1,21:1,2:1};var le=ai(2);wh(54,72,{95:1},Ai,Bi);var ke=ai(54);wh(359,1,{});wh(93,1,{},Ci);_.vb=function(a){return a.l};var me=ai(93);wh(45,9,Ks,Di,Ei);var oe=ai(45);wh(253,1,{30:1});_.tb=Dt;_.Bb=function(){return new uk(this,0)};_.Cb=function(){return new Mk(null,this.Bb())};_.wb=function(a){throw nh(new Ei('Add not supported on this collection'))};_.xb=function(){var a;for(a=this.ub();a.Gb();){a.Hb();a.Ib()}};_.yb=function(a){return Fi(this,a,false)};_.zb=function(){return this.Ab()==0};_.Db=function(){return this.Eb($c(ie,Es,1,this.Ab(),5,1))};_.Eb=function(a){var b,c,d,e;e=this.Ab();a.length<e&&(a=el(new Array(e),a));d=a;c=this.ub();for(b=0;b<e;++b){d[b]=c.Hb()}a.length>e&&(a[e]=null);return a};_.P=function(){var a,b,c;c=new xk(', ','[',']');for(b=this.ub();b.Gb();){a=b.Hb();vk(c,a===this?'(this Collection)':a==null?Ls:Ah(a))}return !c.g?c.i:c.l.length==0?c.g.g:c.g.g+(''+c.l)};var pe=ai(253);wh(256,1,{238:1});_.M=function(a){var b,c,d;if(a===this){return true}if(!jd(a,47)){return false}d=a;if(this.g.h+this.h.h!=d.g.h+d.h.h){return false}for(c=new Vi((new Ri(d)).g);c.h;){b=Ti(c);if(!Hi(this,b)){return false}}return true};_.O=function(){return pj(new Ri(this))};_.P=function(){var a,b,c;c=new xk(', ','{','}');for(b=new Vi((new Ri(this)).g);b.h;){a=Ti(b);vk(c,Ii(this,a.Pb())+'='+Ii(this,a.Qb()))}return !c.g?c.i:c.l.length==0?c.g.g:c.g.g+(''+c.l)};var Be=ai(256);wh(116,256,{238:1});var se=ai(116);wh(255,253,Os);_.Bb=function(){return new uk(this,1)};_.M=function(a){var b;if(a===this){return true}if(!jd(a,68)){return false}b=a;if(b.Ab()!=this.Ab()){return false}return Gi(this,b)};_.O=function(){return pj(this)};var De=ai(255);wh(33,255,Os,Ri);_.xb=zt;_.yb=function(a){return Qi(this,a)};_.ub=function(){return new Vi(this.g)};_.Ab=At;var re=ai(33);wh(36,1,{},Vi);_.Fb=xt;_.Hb=function(){return Ti(this)};_.Gb=Bt;_.Ib=function(){Ui(this)};_.h=false;var qe=ai(36);wh(254,253,Ps);_.Bb=function(){return new uk(this,16)};_.Jb=function(a,b){throw nh(new Ei('Add not supported on this list'))};_.wb=function(a){this.Jb(this.Ab(),a);return true};_.xb=function(){this.Nb(0,this.Ab())};_.M=function(a){var b,c,d,e,f;if(a===this){return true}if(!jd(a,62)){return false}f=a;if(this.Ab()!=f.Ab()){return false}e=f.ub();for(c=this.ub();c.Gb();){b=c.Hb();d=e.Hb();if(!(pd(b)===pd(d)||b!=null&&u(b,d))){return false}}return true};_.O=function(){return qj(this)};_.ub=function(){return new Xi(this)};_.Lb=function(a){return new Yi(this,a)};_.Mb=function(a){throw nh(new Ei('Remove not supported on this list'))};_.Nb=function(a,b){var c,d;d=this.Lb(a);for(c=a;c<b;++c){d.Hb();d.Ib()}};var ve=ai(254);wh(73,1,{},Xi);_.Fb=xt;_.Gb=function(){return this.h<this.j.Ab()};_.Hb=function(){this.h<this.j.Ab();return this.j.Kb(this.i=this.h++)};_.Ib=yt;_.h=0;_.i=-1;var te=ai(73);wh(106,73,{},Yi);_.Ib=yt;_.Ob=function(a){this.g.Jb(this.h,a);++this.h;this.i=-1};var ue=ai(106);wh(110,255,Os,Zi);_.xb=zt;_.yb=Ct;_.ub=function(){var a;return a=new Vi((new Ri(this.g)).g),new $i(a)};_.Ab=At;var xe=ai(110);wh(74,1,{},$i);_.Fb=xt;_.Gb=function(){return this.g.h};_.Hb=function(){var a;a=Ti(this.g);return a.Pb()};_.Ib=function(){Ui(this.g)};var we=ai(74);wh(108,1,Qs);_.M=function(a){var b;if(!jd(a,42)){return false}b=a;return rj(this.g,b.Pb())&&rj(this.h,b.Qb())};_.Pb=vt;_.Qb=Bt;_.O=function(){return ek(this.g)^ek(this.h)};_.Rb=function(a){var b;b=this.h;this.h=a;return b};_.P=function(){return this.g+'='+this.h};var ye=ai(108);wh(109,108,Qs,_i);var ze=ai(109);wh(257,1,Qs);_.M=function(a){var b;if(!jd(a,42)){return false}b=a;return rj(this.h.value[0],b.Pb())&&rj(Rj(this),b.Qb())};_.O=function(){return ek(this.h.value[0])^ek(Rj(this))};_.P=function(){return this.h.value[0]+'='+Rj(this)};var Ae=ai(257);wh(260,254,Ps);_.Jb=function(a,b){var c;c=this.Lb(a);c.Ob(b)};_.Kb=function(a){var b;b=this.Lb(a);return b.Hb()};_.ub=function(){return Xj(this,0)};_.Mb=function(a){var b,c;b=this.Lb(a);c=b.Hb();b.Ib();return c};var Ce=ai(260);wh(14,254,Rs,kj,lj);_.Jb=function(a,b){bl(this.g,a,b)};_.wb=function(a){return bj(this,a)};_.xb=function(){this.g=$c(ie,Es,1,0,5,1)};_.yb=function(a){return fj(this,a,0)!=-1};_.tb=function(a){dj(this,a)};_.Kb=function(a){return ej(this,a)};_.zb=function(){return this.g.length==0};_.ub=function(){return new mj(this)};_.Mb=function(a){return gj(this,a)};_.Nb=function(a,b){var c;c=b-a;dl(this.g,a,c)};_.Ab=function(){return this.g.length};_.Db=function(){return _k(this.g,this.g.length)};_.Eb=function(a){var b,c;c=this.g.length;a.length<c&&(a=el(new Array(c),a));for(b=0;b<c;++b){a[b]=this.g[b]}a.length>c&&(a[c]=null);return a};var Fe=ai(14);wh(27,1,{},mj);_.Fb=xt;_.Gb=function(){return this.g<this.i.g.length};_.Hb=function(){return this.h=this.g++,this.i.g[this.h]};_.Ib=function(){gj(this.i,this.g=this.h);this.h=-1};_.g=0;_.h=-1;var Ee=ai(27);wh(47,116,{3:1,47:1,238:1},sj);var Ge=ai(47);wh(166,255,{3:1,30:1,68:1},vj);_.wb=function(a){return tj(this,a)};_.xb=zt;_.yb=Ct;_.zb=function(){return Pi(this.g)==0};_.ub=function(){var a;return a=new Vi((new Ri((new Zi(this.g)).g)).g),new $i(a)};_.Ab=At;var He=ai(166);wh(75,1,{},Bj);_.tb=Dt;_.ub=function(){return new Cj(this)};_.h=0;var Je=ai(75);wh(76,1,{},Cj);_.Fb=xt;_.Hb=function(){return this.j=this.g[this.i++],this.j};_.Gb=function(){var a;if(this.i<this.g.length){return true}a=this.h.next();if(!a.done){this.g=a.value[1];this.i=0;return true}return false};_.Ib=function(){Aj(this.l,this.j.Pb());this.i!=0&&--this.i};_.i=0;_.j=null;var Ie=ai(76);var Fj;wh(77,1,{},Pj);_.tb=Dt;_.ub=function(){return new Qj(this)};_.h=0;_.i=0;var Me=ai(77);wh(78,1,{},Qj);_.Fb=xt;_.Hb=function(){return this.i=this.g,this.g=this.h.next(),new Sj(this.j,this.i,this.j.i)};_.Gb=function(){return !this.g.done};_.Ib=function(){Oj(this.j,this.i.value[0])};var Ke=ai(78);wh(117,257,Qs,Sj);_.Pb=function(){return this.h.value[0]};_.Qb=function(){return Rj(this)};_.Rb=function(a){return Nj(this.g,this.h.value[0],a)};_.i=0;var Le=ai(117);wh(157,260,Rs,_j);_.wb=function(a){Wj(this,a,this.i.h,this.i);return true};_.xb=function(){$j(this)};_.Lb=function(a){return Xj(this,a)};_.Ab=Bt;_.h=0;var Pe=ai(157);wh(158,1,{},bk);_.Fb=xt;_.Ob=function(a){Wj(this.j,a,this.h.h,this.h);++this.g;this.i=null};_.Gb=function(){return this.h!=this.j.i};_.Hb=function(){return ak(this)};_.Ib=function(){var a;a=this.i.g;Zj(this.j,this.i);this.h==this.i?(this.h=a):--this.g;this.i=null};_.g=0;_.i=null;var Ne=ai(158);wh(59,1,{},ck);var Oe=ai(59);wh(200,1,{},lk);_.g=0;_.h=0;var fk,gk,hk=0;var Qe=ai(200);wh(119,1,{});_.Fb=Ft;_.Sb=function(){return this.j};_.Tb=Et;_.j=0;_.l=0;var Ue=ai(119);wh(79,119,{});var Re=ai(79);wh(111,1,{});_.Fb=Ft;_.Sb=Bt;_.Tb=function(){return this.j-this.i};_.h=0;_.i=0;_.j=0;var Te=ai(111);wh(112,111,{},sk);_.Fb=function(a){pk(this,a)};_.Ub=function(a){return qk(this,a)};var Se=ai(112);wh(28,1,{},uk);_.Sb=vt;_.Tb=function(){tk(this);return this.i};_.Fb=function(a){tk(this);this.j.Fb(a)};_.Ub=function(a){tk(this);if(this.j.Gb()){a.U(this.j.Hb());return true}return false};_.g=0;_.i=0;var Ve=ai(28);wh(44,1,{},wk,xk);_.P=function(){return !this.g?this.i:this.l.length==0?this.g.g:this.g.g+(''+this.l)};var We=ai(44);wh(69,1,{},yk);_.vb=function(a){return a};var Xe=ai(69);wh(82,1,{},zk);var Ye=ai(82);wh(118,1,{});_.i=false;var gf=ai(118);wh(29,118,{},Mk);var Dk;var ff=ai(29);wh(94,1,{},Pk);_.Vb=function(a){return Ek(),$c(ie,Es,1,a,5,1)};var Ze=ai(94);wh(80,79,{},Rk);_.Ub=function(a){this.h=false;while(!this.h&&this.i.Ub(new Sk(this,a)));return this.h};_.h=false;var _e=ai(80);wh(123,1,{},Sk);_.U=function(a){Qk(this.g,this.h,a)};var $e=ai(123);wh(120,79,{},Uk);_.Ub=function(a){return this.h.Ub(new Vk(this,a))};var bf=ai(120);wh(122,1,{},Vk);_.U=function(a){Tk(this.g,this.h,a)};var af=ai(122);wh(121,1,{},Xk);_.U=function(a){Wk(this,a)};var cf=ai(121);wh(124,1,{},Yk);_.U=function(a){Ek()};var df=ai(124);wh(125,1,{},$k);_.U=function(a){Zk(this,a)};var ef=ai(125);wh(357,1,{});wh(354,1,{});var gl=0;var il,jl=0,kl;wh(1355,1,{});wh(1387,1,{});wh(83,1,{},Cl);_.Vb=function(a){return new Array(a)};var hf=ai(83);wh(307,$wnd.Function,{},Dl);_.Xb=function(a){Bl(this.g,this.h,a)};wh(38,15,{3:1,21:1,15:1,38:1},cm);var $l,_l,am;var jf=bi(38,dm);wh(8,15,{3:1,21:1,15:1,8:1},Bm);var em,fm,gm,hm,im,jm,km,lm,mm,nm,om,pm,qm,rm,sm,tm,um,vm,wm,xm,ym,zm;var kf=bi(8,Cm);var Dm;wh(292,$wnd.Function,{},Fm);_._=function(a){return Jb(Dm),Dm=null,null};wh(86,1,{86:1},Gm);var lf=ai(86);wh(58,1,{58:1});var mf=ai(58);wh(148,58,{10:1,58:1},Nm);_.S=Gt;_.T=Ht;_.P=function(){var a;return Yh(qf),qf.v+'@'+(a=hl(this)>>>0,a.toString(16))};var Km=0;var qf=ai(148);wh(149,1,Ds,Om);_.Q=function(){cb(this.g.j)};var nf=ai(149);wh(150,1,Ds,Pm);_.Q=function(){eb(this.g.g)};var of=ai(150);wh(151,1,Ds,Qm);_.Q=function(){Im(this.g,this.h)};var pf=ai(151);wh(159,1,{});var bg=ai(159);wh(160,159,Fs,Tm);_.S=Gt;_.T=Ht;_.P=function(){var a;return Yh(wf),wf.v+'@'+(a=hl(this)>>>0,a.toString(16))};var Rm=0;var wf=ai(160);wh(161,1,Ds,Um);_.Q=function(){W(this.g.g)};var rf=ai(161);wh(163,1,{},Vm);_.Q=function(){Eh(this.g.i)};var sf=ai(163);wh(164,1,{},Wm);_.Q=function(){Fh(this.g.i)};var tf=ai(164);wh(162,1,{},Xm);_.R=function(){var a;return a=$wnd.location.hash,a.length==0?a:a.substr(1)};var uf=ai(162);wh(165,1,Ds,Ym);_.Q=Lt;var vf=ai(165);wh(60,1,{60:1});_.K=0;var cg=ai(60);wh(61,60,{10:1,60:1},En);_.S=function(){hc(this.H)};_.T=function(){return this.H.s<0};_.P=function(){var a;return Yh(If),If.v+'@'+(a=hl(this)>>>0,a.toString(16))};_.v=false;_.A=false;_.G=false;var mn=0;var If=ai(61);wh(221,1,Ds,Fn);_.Q=function(){nn(this.g)};var xf=ai(221);wh(222,1,{},Gn);_.R=function(){return tn(this.g)};var yf=ai(222);wh(223,1,{},Hn);_.Q=function(){cn(this.g)};var zf=ai(223);wh(224,1,Ds,In);_.Q=function(){on(this.g,this.h)};var Af=ai(224);wh(87,1,Ds,Jn);_.Q=function(){en(this.g,this.h)};_.h=false;var Bf=ai(87);wh(225,1,Ds,Kn);_.Q=function(){un(this.g)};var Cf=ai(225);wh(226,1,Ds,Ln);_.Q=function(){jn(this.g)};var Df=ai(226);wh(227,1,Ds,Mn);_.Q=function(){kn(this.g)};var Ef=ai(227);wh(228,1,Ds,Nn);_.Q=function(){fn(this.g,this.h)};var Ff=ai(228);wh(229,1,Ds,On);_.Q=function(){gn(this.g)};var Gf=ai(229);wh(230,1,Ds,Pn);_.Q=function(){hn(this.g,this.h)};var Hf=ai(230);wh(201,1,{});_.F=false;_.G=false;var ug=ai(201);wh(202,201,Fs,Zo);_.S=function(){hc(this.A)};_.T=function(){return this.A.s<0};_.P=function(){var a;return Yh(_f),_f.v+'@'+(a=hl(this)>>>0,a.toString(16))};var xo=0;var _f=ai(202);wh(203,1,Ds,$o);_.Q=function(){zo(this.g)};var Jf=ai(203);wh(204,1,Ds,_o);_.Q=function(){yo(this.g)};var Kf=ai(204);wh(205,1,{},ap);_.R=function(){return Eo(this.g)};var Lf=ai(205);wh(206,1,{},bp);_.R=function(){return Rn(this.g)};var Mf=ai(206);wh(207,1,Ds,cp);_.Q=function(){Ao(this.g,this.h)};var Nf=ai(207);wh(208,1,Ds,dp);_.Q=function(){to(this.g)};var Of=ai(208);wh(209,1,Ds,ep);_.Q=function(){oo(this.g)};var Pf=ai(209);wh(210,1,Ds,fp);_.Q=function(){io(this.g,this.h)};var Qf=ai(210);wh(211,1,Ds,gp);_.Q=function(){no(this.g,this.h)};var Rf=ai(211);wh(212,1,Ds,hp);_.Q=function(){mo(this.g,this.h)};var Sf=ai(212);wh(85,1,Ds,ip);_.Q=function(){co(this.g,(jq(),hq))};var Tf=ai(85);wh(213,1,Ds,jp);_.Q=function(){jo(this.g,this.h)};var Uf=ai(213);wh(214,1,Ds,kp);_.Q=function(){Fo(this.g,this.h)};var Vf=ai(214);wh(215,1,Ds,lp);_.Q=function(){ho(this.g,this.h)};var Wf=ai(215);wh(216,1,Ds,mp);_.Q=function(){lo(this.g,this.h)};var Xf=ai(216);wh(217,1,Ds,np);_.Q=function(){qo(this.g)};var Yf=ai(217);wh(218,1,Ds,op);_.Q=function(){Go(this.g,this.h)};var Zf=ai(218);wh(219,1,Ds,pp);_.Q=function(){Ho(this.g,this.h)};var $f=ai(219);wh(145,1,{},qp);_.handleEvent=function(a){Sm(this.g)};var ag=ai(145);wh(336,$wnd.Function,{},rp);_.eb=function(a,b,c){return Wh(),a.enabled?true:false};wh(329,$wnd.Function,{},sp);_.hb=It;wh(330,$wnd.Function,{},tp);_.hb=It;wh(331,$wnd.Function,{},up);_.jb=function(a){return $m(this.g,this.h,a)};_.h=0;wh(332,$wnd.Function,{},vp);_.kb=function(a){return _m(this.g,this.h,a)};_.h=0;wh(333,$wnd.Function,{},wp);_.gb=function(a){an(this.g,a)};wh(335,$wnd.Function,{},xp);_.bb=function(a){bn(this.g)};wh(334,$wnd.Function,{},yp);_.gb=function(a){ln(a)};wh(269,$wnd.Function,{},zp);_.gb=function(a){s('live',a.readyState)&&a.stop()};wh(185,1,{},Ap);_.Wb=function(){return $wnd.navigator.mediaDevices.getUserMedia(Lh(Kh({}),Mh(Nh({},Hh(Gh(Ih({},160),640),1280)),Hh(Gh(Ih({},120),360),720))))};var dg=ai(185);wh(317,$wnd.Function,{},Bp);_.bb=function(a){Ko(this.g,a)};wh(189,1,{},Cp);_.U=Jt;var eg=ai(189);wh(328,$wnd.Function,{},Dp);_.ib=function(a){Oo(this.g,a)};wh(194,1,{},Ep);_.U=Jt;var fg=ai(194);wh(186,1,{},Fp);_.U=Kt;var gg=ai(186);wh(187,1,{},Gp);_.Wb=function(){return $wnd.navigator.mediaDevices.getDisplayMedia(Jh({}))};var hg=ai(187);wh(188,1,{},Hp);_.U=Kt;var ig=ai(188);wh(310,$wnd.Function,{},Ip);_.bb=function(a){No(this.g,a)};wh(311,$wnd.Function,{},Jp);_.cb=function(a){Mo(this.g,a)};wh(312,$wnd.Function,{},Kp);_.ab=function(a){Jo(this.g,a)};wh(313,$wnd.Function,{},Lp);_.bb=function(a){Lo(this.g,a)};wh(315,$wnd.Function,{},Mp);_.lb=function(a){ko(this.g,a)};wh(316,$wnd.Function,{},Np);_.mb=function(a){Po(this.g,a)};wh(24,15,{3:1,21:1,15:1,24:1},Up);var Op,Pp,Qp,Rp,Sp;var jg=bi(24,Vp);wh(39,15,{3:1,21:1,15:1,39:1},$p);var Wp,Xp,Yp;var kg=bi(39,_p);wh(16,15,{3:1,21:1,15:1,16:1},kq);var aq,bq,cq,dq,eq,fq,gq,hq,iq;var lg=bi(16,lq);wh(318,$wnd.Function,{},mq);_.bb=function(a){fo(this.g)};wh(319,$wnd.Function,{},nq);_.gb=function(a){Sn(this.g,this.h,a)};wh(308,$wnd.Function,{},oq);_.gb=function(a){Tn(this.g,a)};wh(327,$wnd.Function,{},pq);_.fb=function(a){return uo(this.g,a)};wh(320,$wnd.Function,{},qq);_.jb=function(a){return Un(this.g,a)};wh(321,$wnd.Function,{},rq);_.jb=function(a){return Vn(this.g)};wh(322,$wnd.Function,{},sq);_.kb=function(a){return Wn(this.g,a)};wh(323,$wnd.Function,{},tq);_.gb=function(a){Xn(this.g,a)};wh(190,1,{},uq);_.fb=function(a){return Yn(this.g,a)};var mg=ai(190);wh(191,1,{},vq);_.U=function(a){};var ng=ai(191);wh(192,1,{},wq);_.Wb=function(){return $wnd.Promise.resolve(this.g)};var og=ai(192);wh(193,1,{},xq);_.fb=function(a){return Zn(this.g,a)};var pg=ai(193);wh(195,1,{},yq);_.fb=function(a){return vo(this.g,a)};var qg=ai(195);wh(324,$wnd.Function,{},zq);_.jb=function(a){return $n(this.g,a)};wh(325,$wnd.Function,{},Aq);_.jb=function(a){return _n(this.g)};wh(326,$wnd.Function,{},Bq);_.kb=function(a){return ao(this.g,a)};wh(196,1,Ds,Cq);_.Q=function(){bo(this.g,this.h)};var rg=ai(196);wh(197,1,Ds,Dq);_.Q=function(){ro(this.g,sl('reject_access','id',this.h.g))};var sg=ai(197);wh(198,1,{},Eq);_.fb=function(a){return wo(this.g,a)};var tg=ai(198);wh(127,1,{});var wg=ai(127);wh(92,1,{},Fq);var vg=ai(92);wh(128,127,{});_.j=0;var Vg=ai(128);wh(129,128,Fs,Lq);_.S=Gt;_.T=Ht;_.P=function(){var a;return Yh(Bg),Bg.v+'@'+(a=hl(this)>>>0,a.toString(16))};var Jq=0;var Bg=ai(129);wh(130,1,Ds,Mq);_.Q=function(){cb(this.g.l)};var xg=ai(130);wh(131,1,Ds,Nq);_.Q=function(){pb(this.g.g)};var yg=ai(131);wh(133,1,{},Oq);_.R=function(){return Hq(this.g)};var zg=ai(133);wh(132,1,{},Pq);_.Q=function(){Iq(this.g)};var Ag=ai(132);wh(144,1,{});var eh=ai(144);wh(174,144,{});_.l=0;var Xg=ai(174);wh(175,174,Fs,er);_.S=function(){hc(this.i)};_.T=function(){return this.i.s<0};_.P=function(){var a;return Yh(Lg),Lg.v+'@'+(a=hl(this)>>>0,a.toString(16))};var ar=0;var Lg=ai(175);wh(176,1,Ds,fr);_.Q=function(){cb(this.g.u)};var Cg=ai(176);wh(177,1,Ds,gr);_.Q=function(){br(this.g)};var Dg=ai(177);wh(179,1,{},hr);_.Q=function(){Vq(this.g)};var Eg=ai(179);wh(180,1,{},ir);_.Q=function(){Wq(this.g)};var Fg=ai(180);wh(182,1,Ds,jr);_.Q=function(){hc(this.g.i)};var Gg=ai(182);wh(183,1,{},kr);_.R=function(){return $q(this.g)};var Hg=ai(183);wh(184,1,Ds,lr);_.Q=Lt;var Ig=ai(184);wh(178,1,{},mr);_.R=function(){return Wh(),$wnd.document.fullscreen?true:false};var Jg=ai(178);wh(181,1,{},nr);_.Q=function(){_q(this.g)};var Kg=ai(181);wh(259,1,{});var hh=ai(259);wh(167,259,{});_.m=0;var Zg=ai(167);wh(168,167,Fs,xr);_.S=function(){hc(this.j)};_.T=function(){return this.j.s<0};_.P=function(){var a;return Yh(Rg),Rg.v+'@'+(a=hl(this)>>>0,a.toString(16))};var tr=0;var Rg=ai(168);wh(169,1,Ds,yr);_.Q=function(){ur(this.g)};var Mg=ai(169);wh(171,1,Ds,zr);_.Q=function(){hc(this.g.j)};var Ng=ai(171);wh(172,1,Ds,Ar);_.Q=function(){vr(this.g,this.h)};var Og=ai(172);wh(173,1,{},Br);_.R=function(){return rr(this.g)};var Pg=ai(173);wh(170,1,{},Cr);_.Q=function(){sr(this.g)};var Qg=ai(170);wh(199,1,{});var jh=ai(199);wh(231,199,{});var _g=ai(231);wh(232,231,Fs,Hr);_.S=function(){hc(this.g)};_.T=function(){return this.g.s<0};_.P=function(){var a;return Yh(Tg),Tg.v+'@'+(a=hl(this)>>>0,a.toString(16))};var Gr=0;var Tg=ai(232);wh(233,1,Ds,Ir);_.Q=function(){hc(this.g.g)};var Sg=ai(233);wh(291,$wnd.Function,{},Jr);_.$b=function(a){return new Mr(a)};var Kr;wh(113,$wnd.React.Component,{},Mr);vh(th[1],_);_.componentWillUnmount=function(){Gq(this.g)};_.render=function(){return Kq(this.g)};_.shouldComponentUpdate=function(a){return 1==this.g.j};var Ug=ai(113);wh(296,$wnd.Function,{},Nr);_.$b=function(a){return new Qr(a)};var Or;wh(154,$wnd.React.Component,{},Qr);vh(th[1],_);_.componentWillUnmount=function(){db(this.g)&&Zq(this.g)};_.render=function(){return db(this.g)?cr(this.g):null};_.shouldComponentUpdate=function(a){return db(this.g)&&1==this.g.l};var Wg=ai(154);wh(293,$wnd.Function,{},Rr);_.$b=function(a){return new Ur(a)};var Sr;wh(152,$wnd.React.Component,{},Ur);vh(th[1],_);_.componentWillUnmount=function(){db(this.g)&&qr(this.g)};_.render=function(){return db(this.g)?wr(this.g):null};_.shouldComponentUpdate=function(a){return db(this.g)&&1==this.g.m};var Yg=ai(152);wh(337,$wnd.Function,{},Vr);_.$b=function(a){return new Yr(a)};var Wr;wh(220,$wnd.React.Component,{},Yr);vh(th[1],_);_.componentWillUnmount=function(){db(this.g)&&hc(this.g.g)};_.render=function(){return db(this.g)?Er(this.g):null};_.shouldComponentUpdate=function(a){return db(this.g)&&Fr(this.g,a)};var $g=ai(220);wh(156,1,{},Zr);_.vb=function(a){var b;return Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['video-list-item'])),[Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['video-list-item-wrapper'])),[zs(xs(ys(new As,a),'video-list-item-element'),false)]),(b=(kb(a.o),a.D),null!=b&&b.getAudioTracks().length>0?Al(pt,El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['video-list-item-controls'])),[Al(Xs,Ll(El(new $wnd.Object,bd(Yc(le,1),Es,2,6,['video-list-item-control-btn'])),yh(ks.prototype.Zb,ks,[a])),[Al(st,Ol(Ql(Pl(new $wnd.Object,X(a.g)?tt:ut),16),16),null)])]):null)])};var ah=ai(156);wh(304,$wnd.Function,{},$r);_.Yb=function(a){a.preventDefault()};wh(267,$wnd.Function,{},_r);_.Yb=function(a){Yq(this.g,a)};wh(155,1,{},as);_.handleEvent=function(a){dr(this.g)};var bh=ai(155);wh(297,$wnd.Function,{},bs);_.U=function(a){Qq(this.g,a)};wh(305,$wnd.Function,{},cs);_.Zb=function(a){Rq(this.g,this.h,a)};wh(306,$wnd.Function,{},ds);_.Zb=function(a){Sq(this.g,this.h,a)};wh(268,$wnd.Function,{},es);_.Yb=function(a){Tq(this.g,a)};wh(298,$wnd.Function,{},fs);_.Zb=function(a){Yo(this.g.u)};wh(299,$wnd.Function,{},gs);_.Zb=Mt;wh(300,$wnd.Function,{},hs);_.Zb=function(a){Dn(this.g)};wh(301,$wnd.Function,{},is);_.Zb=function(a){Uq(this.g)};wh(302,$wnd.Function,{},js);_.Zb=function(a){Io(this.g.u)};wh(303,$wnd.Function,{},ks);_.Zb=Mt;wh(143,1,{},os);var dh=ai(143);wh(294,$wnd.Function,{},ps);_.Yb=function(a){or(this.g,a)};wh(153,1,{},qs);_.vb=function(a){return Al('a',Jl(El(Gl(new $wnd.Object,a),bd(Yc(le,1),Es,2,6,['recent-room'])),'#'+a),[a])};var fh=ai(153);wh(295,$wnd.Function,{},rs);_.Yb=function(a){var b;pr(this.g,ui((b=a.target,b).value))};wh(142,1,{},us);var gh=ai(142);wh(338,$wnd.Function,{},vs);_.U=function(a){Dr(this.g,a)};wh(84,1,{},As);var ih=ai(84);var td=ci('I');var rd=ci('D');var sd=ci('F');var kh=ci('S');var Bs=(Dc(),Gc);var gwtOnLoad=gwtOnLoad=rh;ph(Ch);sh('permProps',[[]]);if (vchat) vchat.onScriptLoad(gwtOnLoad);})();