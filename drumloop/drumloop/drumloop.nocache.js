...
drumloop();(function () {var $gwt_version = "2.8.2";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {$wnd.__gwtStatsEvent(a)} : null;var $strongName = '82F41D3001B96B9ED0658C0050902063';function l(){}
function Lf(){}
function Hf(){}
function mb(){}
function dc(){}
...
function el(a,b){Th(a.a,b?b.e:null);eh(b);a.a.props['a']=b;return a.a}
function Ql(a,b){Th(a.a,b?''+b.d:null);eh(b);a.a.props['a']=b;return a.a}
...
function Rj(a,b){var c,d,e,f,g;c=(d=a.g.props['a'],e=Ti(d.c),f=e.createBufferSource(),f.buffer=d.b,g=e.createGain(),f.connect(g),g.gain.value=0.2,g.connect(e.destination),f);c.loop=b;c.onended=If(dl.prototype.v,dl,[a,c]);c.start(0);a.f=c}
...
function Vi(a){var b,c,d,e;V(a.c);if(a.e){c=(V(a.b),(a.d+1)%16);for(e=new Jg(a.j);e.a<e.c.a.length;){d=(e.b=e.a++,e.c.a[e.b]);b=zg(d.a,c);V(b.a);if(b.b!=0){V(b.a);if(b.b==2){Wi(a,d.b);Rf();$wnd.window.setTimeout(If(uj.prototype.u,uj,[a,d]),100)}else{Wi(a,d.b)}}}Eb(new hj(a,c));Rf();$wnd.window.setTimeout(If(vj.prototype.u,vj,[a]),60/a.h*1000)}}
