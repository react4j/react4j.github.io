...
drumloop();(function () {var $gwt_version = "2.8.2";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {$wnd.__gwtStatsEvent(a)} : null;var $strongName = 'F7B3DC69003C72C0E88F947465D9ACD4';function l(){}
function Lf(){}
function Hf(){}
function mb(){}
function dc(){}
...
function Xl(){if(!Wl){Wl=(++(C(),C(),B).e,new mb);$wnd.Promise.resolve(null).then(If(Yl.prototype.w,Yl,[]))}}
function Vi(a,b){return (Rf(),$wnd.window.fetch(b)).then(If(tj.prototype.w,tj,[])).then(If(uj.prototype.w,uj,[a.g]))}
...
function Sj(a,b){var c,d,e,f,g;c=(d=a.g.props['a'],e=Ui(d.c),f=e.createBufferSource(),f.buffer=d.b,g=e.createGain(),f.connect(g),g.gain.value=0.2,g.connect(e.destination),f);c.loop=b;c.onended=If(el.prototype.v,el,[a,c]);c.start(0);a.f=c}
