function todomvc(){var nb='',ob=0,pb='gwt.codesvr=',qb='gwt.hosted=',rb='gwt.hybrid',sb='todomvc',tb='__gwt_marker_todomvc',ub='<script id="',vb='"><\/script>',wb='SCRIPT',xb='#',yb='?',zb='/',Ab=1,Bb='base',Cb='img',Db='clear.cache.gif',Eb='meta',Fb='name',Gb='gwt:property',Hb='content',Ib='=',Jb='gwt:onPropertyErrorFn',Kb='Bad handler "',Lb='" for "gwt:onPropertyErrorFn"',Mb='gwt:onLoadErrorFn',Nb='" for "gwt:onLoadErrorFn"',Ob='Single-script hosted mode not yet implemented. See issue ',Pb='http://code.google.com/p/google-web-toolkit/issues/detail?id=2079',Qb='F33B7A772798989230C9D422EE164FE0',Rb=':',Sb='DOMContentLoaded',Tb=50;var k=nb,l=ob,m=pb,n=qb,o=rb,p=sb,q=tb,r=ub,s=vb,t=wb,u=xb,v=yb,w=zb,A=Ab,B=Bb,C=Cb,D=Db,F=Eb,G=Fb,H=Gb,I=Hb,J=Ib,K=Jb,L=Kb,M=Lb,N=Mb,O=Nb,P=Ob,Q=Pb,R=Qb,S=Rb,T=Sb,U=Tb;var V=window,W=document,X,Y,Z=k,$={},_=[],ab=[],bb=[],cb=l,db,eb;if(!V.__gwt_stylesLoaded){V.__gwt_stylesLoaded={}}if(!V.__gwt_scriptsLoaded){V.__gwt_scriptsLoaded={}}function fb(){var b=false;try{var c=V.location.search;return (c.indexOf(m)!=-1||(c.indexOf(n)!=-1||V.external&&V.external.gwtOnLoad))&&c.indexOf(o)==-1}catch(a){}fb=function(){return b};return b}
...
todomvc();(function () {var $gwt_version = "2.8.2";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {$wnd.__gwtStatsEvent(a)} : null;var $strongName = 'F33B7A772798989230C9D422EE164FE0';function o(){}
function Yg(){}
function Ug(){}
function Bb(){}
function Qc(){}
...
function zm(a){bb(a.b);return a.i}
function Am(a){bb(a.a);return a.g}
function kn(a){bb(a.d);return a.f}
...
function Xk(a){nc(a.c);gb(a.a);W(a.b)}
function Cm(a){vm(a,(bb(a.a),!a.g))}
...
function el(a,b){jn((tm(),sm),b);sl(a,b)}
...
function Bm(a){nc(a.c);W(a.d);W(a.b);W(a.a)}
...
function Wk(a,b){var c;c=b.target;Tk(a,c.value)}
...
function Tk(a,b){var c;c=a.e;if(b!=c){a.e=b;ab(a.b)}}
function ml(a,b){var c;c=a.i;if(b!=c){a.i=b;ab(a.a)}}
function vm(a,b){var c;c=a.g;if(b!=c){a.g=b;ab(a.a)}}
...
function pl(a,b,c,d){return dh(),ll(a,b,c,d)?true:false}
...
function wm(a,b){var c;c=a.i;if(b!=c){a.i=Ni(b);ab(a.b)}}
...
function Qk(a,b){if(13==b.keyCode){b.preventDefault();Uk(a)}}
...
function nn(a){var b;b=(bb(a.d),a.f);!!b&&!!b&&b.f<0&&jn(a,null)}
function jn(a,b){var c;c=a.f;if(!(b==c||!!b&&ym(b,c))){a.f=b;ab(a.d)}}
...
function yo(){return kn((tm(),sm))==(cb(this.c),this.o.props['a'])}
...
function xm(a){if(a.f>=0){a.f=-2;t((J(),J(),I),new G(new Fm(a)),Qn,null)}}
function mn(a){var b,c;return b=T(a.b),$i(Yi(Km(a.k),new Fn(b)),(c=new gi,c))}
...
function ql(a){return dh(),kn((tm(),sm))==(cb(a.c),a.o.props['a'])?true:false}
...
function Pk(a){var b;b=Ch((bb(a.b),a.e));if(b.length>0){Wm((tm(),rm),b);Tk(a,'')}}
...
function hc(a,b,c){var d;d=Nh(a.i,b?vh(b.e):null);if(null!=d){oc(b.c,a);c&&!!b&&xm(b);ab(a.d)}}
...
function on(a){var b;b=Vb(a.j);Bh(jo,b)||Bh(go,b)||Bh('',b)?Ub(a.j,b):gn(Wb(a.j))?Zb(a.j):Ub(a.j,'')}
...
function ym(a,b){var c;if(a===b){return true}else if(null==b||!ld(b,50)){return false}else{c=b;return a.e==c.e}}
...
function hl(a,b){var c;c=(bb(a.a),a.i);if(null!=c&&c.length!=0){_m((tm(),b),c);jn(sm,null);ml(a,c)}else{Jm((tm(),qm),b)}}
...
function cl(a){var b;b=T(a.d);if(!a.j&&b){a.j=true;sl(a,(cb(a.c),a.o.props['a']));a.g.focus();a.g.select()}else a.j&&!b&&(a.j=false)}
...
function Uk(b){var c;try{A((J(),J(),I),new $k(b),Un)}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){c=a;throw Fg(c)}else if(ld(a,4)){c=a;throw Fg(new th(c))}else throw Fg(a)}}
...
function Vk(b,c){var d;try{A((J(),J(),I),new _k(b,c),Un)}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){d=a;throw Fg(d)}else if(ld(a,4)){d=a;throw Fg(new th(d))}else throw Fg(a)}}
function nl(b,c){var d;try{A((J(),J(),I),new Al(b,c),Un)}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){d=a;throw Fg(d)}else if(ld(a,4)){d=a;throw Fg(new th(d))}else throw Fg(a)}}
function rl(b,c){var d;try{A((J(),J(),I),new zl(b,c),Un)}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){d=a;throw Fg(d)}else if(ld(a,4)){d=a;throw Fg(new th(d))}else throw Fg(a)}}
function sl(b,c){var d;try{A((J(),J(),I),new yl(b,c),Un)}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){d=a;throw Fg(d)}else if(ld(a,4)){d=a;throw Fg(new th(d))}else throw Fg(a)}}
...
var Hn='object',In='number',Jn=16384,Kn={15:1},Ln={3:1,5:1},Mn={11:1},Nn=1048576,On=1835008,Pn={8:1},Qn=67108864,Rn=4194304,Sn={30:1},Tn='hashchange',Un=142614528,Vn='__noinit__',Wn='__java$exception',Xn={3:1,12:1,6:1,4:1},Yn='null',Zn=17592186044416,$n={44:1},_n='delete',ao='button',bo='selected',co=1478631424,eo={11:1,24:1},fo='input',go='completed',ho='header',io=136323072,jo='active';var _,Qg,Lg,Dg=-1;Rg();Tg(1,null,{},o);_.q=lo;_.r=function(){return this.ub};_.s=mo;_.t=function(){var a;return gh(q(this))+'@'+(a=r(this)>>>0,a.toString(16))};_.equals=function(a){return this.q(a)};_.hashCode=function(){return this.s()};_.toString=function(){return this.t()};var fd,gd,hd;Tg(52,1,{},hh);_.J=function(a){var b;b=new hh;b.e=4;a>1?(b.c=mh(this,a-1)):(b.c=this);return b};_.K=function(){fh(this);return this.b};_.L=function(){return gh(this)};_.M=function(){fh(this);return this.i};_.N=function(){return (this.e&4)!=0};_.O=function(){return (this.e&1)!=0};_.t=function(){return ((this.e&2)!=0?'interface ':(this.e&1)!=0?'':'class ')+(fh(this),this.k)};_.e=0;_.g=0;var eh=1;var je=jh(1);var ae=jh(52);Tg(76,1,{},F);_.a=1;_.c=false;_.d=true;_.e=0;var ud=jh(76);Tg(16,1,Kn,G);_.u=function(){return this.a.A(),null};var sd=jh(16);Tg(77,1,{},H);var td=jh(77);var I;Tg(22,1,{22:1},Q);_.b=0;_.c=false;_.d=0;var vd=jh(22);Tg(202,1,Mn);_.t=function(){var a;return gh(this.ub)+'@'+(a=r(this)>>>0,a.toString(16))};var xd=jh(202);Tg(21,202,Mn,U);_.v=function(){S(this)};_.w=ko;_.a=false;var wd=jh(21);Tg(17,202,{11:1,17:1},eb);_.v=function(){W(this)};_.w=function(){return -2==this.e};_.a=4;_.d=false;_.e=0;var zd=jh(17);Tg(116,1,Pn,fb);_.A=function(){X(this.a)};var yd=jh(116);Tg(19,202,{11:1,19:1},qb,rb);_.v=function(){gb(this)};_.w=function(){return 1==(this.c&7)};_.c=0;var Dd=jh(19);Tg(117,1,Sn,sb);_.A=function(){R(this.a)};var Ad=jh(117);Tg(118,1,Pn,tb);_.A=function(){lb(this.a)};var Bd=jh(118);Tg(119,1,{},ub);_.B=function(a){jb(this.a,a)};var Cd=jh(119);Tg(121,1,{},zb);_.a=0;_.b=100;_.e=0;var Ed=jh(121);Tg(62,1,Mn,Bb);_.v=function(){Ab(this)};_.w=ko;_.a=false;var Fd=jh(62);Tg(135,1,{},Nb);_.t=function(){var a;return fh(Gd),Gd.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.a=0;var Cb;var Gd=jh(135);Tg(46,1,{46:1});_.e='';_.g='';_.i=true;_.j='';var Nd=jh(46);Tg(101,46,{11:1,46:1,24:1},bc);_.v=function(){if(this.d>=0){this.d=-2;t((J(),J(),I),new G(new cc(this)),Qn,null)}};_.q=lo;_.C=to;_.s=mo;_.w=uo;_.t=function(){var a;return fh(Ld),Ld.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.d=0;var Ld=jh(101);Tg(102,1,Pn,cc);_.A=function(){Xb(this.a)};var Hd=jh(102);Tg(103,1,Pn,dc);_.A=function(){Qb(this.a,this.b)};var Id=jh(103);Tg(104,1,Pn,ec);_.A=function(){Yb(this.a)};var Jd=jh(104);Tg(105,1,Pn,fc);_.A=function(){Tb(this.a)};var Kd=jh(105);Tg(78,1,{},gc);_.handleEvent=function(a){Rb(this.a,a)};var Md=jh(78);Tg(106,1,{});var Qd=jh(106);Tg(79,1,{},kc);_.B=function(a){ic(this.a,a)};var Od=jh(79);Tg(80,1,Pn,lc);_.A=function(){jc(this.a,this.b)};var Pd=jh(80);Tg(107,106,{});var Rd=jh(107);Tg(18,1,Mn,pc);_.v=function(){nc(this)};_.w=ko;_.a=false;var Sd=jh(18);Tg(4,1,{3:1,4:1});_.D=function(a){return new Error(a)};_.F=Do;_.G=function(){var a,b,c;c=this.f==null?null:this.f.replace(new RegExp('\n','g'),' ');b=(a=gh(this.ub),c==null?a:a+': '+c);rc(this,tc(this.D(b)));Vc(this)};_.t=function(){return sc(this,this.F())};_.e=Vn;_.g=true;var ne=jh(4);Tg(12,4,{3:1,12:1,4:1});var de=jh(12);Tg(6,12,Xn);var ke=jh(6);Tg(53,6,Xn);var ge=jh(53);Tg(71,53,Xn);var Wd=jh(71);Tg(40,71,{40:1,3:1,12:1,6:1,4:1},yc);_.F=function(){xc(this);return this.c};_.H=function(){return qd(this.b)===qd(vc)?null:this.b};var vc;var Td=jh(40);var Ud=jh(0);Tg(188,1,{});var Vd=jh(188);var Ac=0,Bc=0,Cc=-1;Tg(100,188,{},Qc);var Mc;var Xd=jh(100);var Tc;Tg(199,1,{});var Zd=jh(199);Tg(72,199,{},Xc);var Yd=jh(72);var $g;Tg(69,1,{66:1});_.t=ko;var $d=jh(69);fd={3:1,67:1,32:1};var _d=jh(67);Tg(45,1,{3:1,45:1});var ie=jh(45);gd={3:1,32:1,45:1};var be=jh(198);Tg(36,1,{3:1,32:1,36:1});_.q=lo;_.s=mo;_.t=function(){return this.a!=null?this.a:''+this.b};_.b=0;var ce=jh(36);Tg(10,6,Xn,sh,th);var ee=jh(10);Tg(33,45,{3:1,32:1,33:1,45:1},uh);_.q=function(a){return ld(a,33)&&a.a==this.a};_.s=ko;_.t=function(){return ''+this.a};_.a=0;var fe=jh(33);var wh;Tg(256,1,{});Tg(74,53,Xn,zh);_.D=function(a){return new TypeError(a)};var he=jh(74);hd={3:1,66:1,32:1,2:1};var me=jh(2);Tg(70,69,{66:1},Fh);var le=jh(70);Tg(260,1,{});Tg(55,6,Xn,Gh);var oe=jh(55);Tg(200,1,{43:1});_.P=qo;_.T=function(){return new Ri(this,0)};_.U=function(){return new _i(null,this.T())};_.R=function(a){throw Fg(new Gh('Add not supported on this collection'))};_.t=function(){var a,b,c;c=new Ti('[',']');for(b=this.Q();b.W();){a=b.X();Si(c,a===this?'(this Collection)':a==null?Yn:Xg(a))}return !c.a?c.c:c.e.length==0?c.a.a:c.a.a+(''+c.e)};var pe=jh(200);Tg(203,1,{186:1});_.q=function(a){var b,c,d;if(a===this){return true}if(!ld(a,41)){return false}d=a;if(this.a.b+this.b.b!=d.a.b+d.b.b){return false}for(c=new Uh((new Rh(d)).a);c.b;){b=Th(c);if(!Jh(this,b)){return false}}return true};_.s=function(){return ji(new Rh(this))};_.t=function(){var a,b,c;c=new Ti('{','}');for(b=new Uh((new Rh(this)).a);b.b;){a=Th(b);Si(c,Kh(this,a.Z())+'='+Kh(this,a.$()))}return !c.a?c.c:c.e.length==0?c.a.a:c.a.a+(''+c.e)};var Ae=jh(203);Tg(122,203,{186:1});var se=jh(122);Tg(204,200,{43:1,210:1});_.T=function(){return new Ri(this,1)};_.q=function(a){var b;if(a===this){return true}if(!ld(a,27)){return false}b=a;if(Ph(b.a)!=this.S()){return false}return Hh(this,b)};_.s=function(){return ji(this)};var Be=jh(204);Tg(27,204,{27:1,43:1,210:1},Rh);_.Q=function(){return new Uh(this.a)};_.S=oo;var re=jh(27);Tg(28,1,{},Uh);_.V=no;_.X=function(){return Th(this)};_.W=po;_.b=false;var qe=jh(28);Tg(201,200,{43:1,208:1});_.T=function(){return new Ri(this,16)};_.Y=function(a,b){throw Fg(new Gh('Add not supported on this list'))};_.R=function(a){this.Y(this.S(),a);return true};_.q=function(a){var b,c,d,e,f;if(a===this){return true}if(!ld(a,14)){return false}f=a;if(this.S()!=f.a.length){return false}e=new ii(f);for(c=new ii(this);c.a<c.c.a.length;){b=(c.b=c.a++,c.c.a[c.b]);d=(e.b=e.a++,e.c.a[e.b]);if(!(qd(b)===qd(d)||b!=null&&p(b,d))){return false}}return true};_.s=function(){return ki(this)};_.Q=function(){return new Vh(this)};var ue=jh(201);Tg(98,1,{},Vh);_.V=no;_.W=function(){return this.a<this.b.a.length};_.X=function(){return ai(this.b,this.a++)};_.a=0;var te=jh(98);Tg(48,200,{43:1},Wh);_.Q=function(){var a;return a=new Uh((new Rh(this.a)).a),new Xh(a)};_.S=oo;var we=jh(48);Tg(57,1,{},Xh);_.V=no;_.W=function(){return this.a.b};_.X=function(){var a;return a=Th(this.a),a.$()};var ve=jh(57);Tg(123,1,$n);_.q=function(a){var b;if(!ld(a,44)){return false}b=a;return li(this.a,b.Z())&&li(this.b,b.$())};_.Z=ko;_.$=po;_.s=function(){return Mi(this.a)^Mi(this.b)};_._=function(a){var b;b=this.b;this.b=a;return b};_.t=function(){return this.a+'='+this.b};var xe=jh(123);Tg(124,123,$n,Yh);var ye=jh(124);Tg(205,1,$n);_.q=function(a){var b;if(!ld(a,44)){return false}b=a;return li(this.b.value[0],b.Z())&&li(Ii(this),b.$())};_.s=function(){return Mi(this.b.value[0])^Mi(Ii(this))};_.t=function(){return this.b.value[0]+'='+Ii(this)};var ze=jh(205);Tg(14,201,{3:1,14:1,43:1,208:1},gi,hi);_.Y=function(a,b){oj(this.a,a,b)};_.R=function(a){return $h(this,a)};_.P=function(a){_h(this,a)};_.Q=function(){return new ii(this)};_.S=function(){return this.a.length};var De=jh(14);Tg(20,1,{},ii);_.V=no;_.W=function(){return this.a<this.c.a.length};_.X=function(){return this.b=this.a++,this.c.a[this.b]};_.a=0;_.b=-1;var Ce=jh(20);Tg(41,122,{3:1,41:1,186:1},mi);var Ee=jh(41);Tg(60,1,{},si);_.P=qo;_.Q=function(){return new ti(this)};_.b=0;var Ge=jh(60);Tg(61,1,{},ti);_.V=no;_.X=function(){return this.d=this.a[this.c++],this.d};_.W=function(){var a;if(this.c<this.a.length){return true}a=this.b.next();if(!a.done){this.a=a.value[1];this.c=0;return true}return false};_.c=0;_.d=null;var Fe=jh(61);var wi;Tg(58,1,{},Gi);_.P=qo;_.Q=function(){return new Hi(this)};_.b=0;_.c=0;var Je=jh(58);Tg(59,1,{},Hi);_.V=no;_.X=function(){return this.c=this.a,this.a=this.b.next(),new Ji(this.d,this.c,this.d.c)};_.W=function(){return !this.a.done};var He=jh(59);Tg(134,205,$n,Ji);_.Z=function(){return this.b.value[0]};_.$=function(){return Ii(this)};_._=function(a){return Ei(this.a,this.b.value[0],a)};_.c=0;var Ie=jh(134);Tg(99,1,{});_.V=function(a){Oi(this,a)};_.ab=function(){return this.d};_.bb=zo;_.d=0;_.e=0;var Le=jh(99);Tg(56,99,{});var Ke=jh(56);Tg(26,1,{},Ri);_.ab=ko;_.bb=function(){Qi(this);return this.c};_.V=function(a){Qi(this);this.d.V(a)};_.cb=function(a){Qi(this);if(this.d.W()){a.B(this.d.X());return true}return false};_.a=0;_.c=0;var Me=jh(26);Tg(54,1,{},Ti);_.t=function(){return !this.a?this.c:this.e.length==0?this.a.a:this.a.a+(''+this.e)};var Ne=jh(54);var We=lh();Tg(125,1,{});_.c=false;var Xe=jh(125);Tg(35,125,{},_i);var Ve=jh(35);Tg(127,56,{},dj);_.cb=function(a){this.b=false;while(!this.b&&this.c.cb(new ej(this,a)));return this.b};_.b=false;var Pe=jh(127);Tg(130,1,{},ej);_.B=function(a){cj(this.a,this.b,a)};var Oe=jh(130);Tg(126,56,{},gj);_.cb=function(a){return this.a.cb(new hj(a))};var Re=jh(126);Tg(129,1,{},hj);_.B=function(a){fj(this.a,a)};var Qe=jh(129);Tg(128,1,{},jj);_.B=function(a){ij(this,a)};var Se=jh(128);Tg(131,1,{},kj);_.B=function(a){};var Te=jh(131);Tg(132,1,{},mj);_.B=function(a){lj(this,a)};var Ue=jh(132);Tg(258,1,{});Tg(207,1,{});var Ye=jh(207);Tg(255,1,{});var tj=0;var vj,wj=0,xj;Tg(682,1,{});Tg(706,1,{});Tg(206,1,{});_.eb=ro;_.fb=ro;_.hb=function(a,b,c){return false};_.p=false;var Ze=jh(206);Tg(34,$wnd.React.Component,{});Sg(Qg[1],_);_.render=function(){return Mj(this.a)};var $e=jh(34);Tg(38,206,{});_.kb=function(){return false};_.mb=function(){return Nj(this)};_.k=false;_.n=false;var Hj=1,Ij;var _e=jh(38);Tg(227,$wnd.Function,{},Oj);_.I=function(a){return Ab(Ij),Ij=null,null};Tg(9,36,{3:1,32:1,36:1,9:1},yk);var bk,ck,dk,ek,fk,gk,hk,ik,jk,kk,lk,mk,nk,ok,pk,qk,rk,sk,tk,uk,vk,wk;var af=kh(9,zk);Tg(156,38,{});_.rb=so;_.gb=function(){var a;a=T((tm(),sm).b);return $wnd.React.createElement('footer',Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['footer'])),Nl(new Ol),$wnd.React.createElement('ul',Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['filters'])),$wnd.React.createElement('li',null,$wnd.React.createElement('a',Rj(Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,[(yn(),wn)==a?bo:null])),'#'),'All')),$wnd.React.createElement('li',null,$wnd.React.createElement('a',Rj(Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,[vn==a?bo:null])),'#active'),'Active')),$wnd.React.createElement('li',null,$wnd.React.createElement('a',Rj(Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,[xn==a?bo:null])),'#completed'),'Completed'))),this.rb()?$wnd.React.createElement(ao,Sj(Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['clear-completed'])),Vg(Kl.prototype.qb,Kl,[])),'Clear Completed'):null)};var If=jh(156);Tg(157,156,{});_.rb=so;var Ak;var Mf=jh(157);Tg(158,157,eo,Dk);_.v=function(){if(this.d>=0){this.d=-2;t((J(),J(),I),new G(new Hk(this)),Qn,null)}};_.q=lo;_.lb=vo;_.C=to;_.rb=function(){return T(this.a)};_.s=mo;_.w=uo;_.t=function(){var a;return fh(kf),kf.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.mb=function(){var b;try{return B((J(),J(),I),this.b,new Fk(this))}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){b=a;throw Fg(b)}else if(ld(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.d=0;var kf=jh(158);Tg(159,1,Kn,Ek);_.u=function(){return dh(),T((tm(),qm).b).a>0?true:false};var bf=jh(159);Tg(162,1,Kn,Fk);_.u=xo;var cf=jh(162);Tg(160,1,Sn,Gk);_.A=wo;var df=jh(160);Tg(161,1,Pn,Hk);_.A=function(){Ck(this.a)};var ef=jh(161);Tg(179,38,{});_.gb=function(){var a,b;b=T((tm(),qm).e).a;a='item'+(b==1?'':'s');return $wnd.React.createElement('span',Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['todo-count'])),$wnd.React.createElement('strong',null,b),' '+a+' left')};var Hf=jh(179);Tg(180,179,{});var Ik;var Lf=jh(180);Tg(181,180,eo,Lk);_.v=function(){if(this.c>=0){this.c=-2;t((J(),J(),I),new G(new Nk(this)),Qn,null)}};_.q=lo;_.lb=vo;_.C=po;_.s=mo;_.w=Ao;_.t=function(){var a;return fh(jf),jf.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.mb=function(){var b;try{return B((J(),J(),I),this.a,new Ok(this))}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){b=a;throw Fg(b)}else if(ld(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.c=0;var jf=jh(181);Tg(182,1,Sn,Mk);_.A=wo;var ff=jh(182);Tg(183,1,Pn,Nk);_.A=function(){Kk(this.a)};var gf=jh(183);Tg(184,1,Kn,Ok);_.u=xo;var hf=jh(184);Tg(148,38,{});_.gb=function(){return $wnd.React.createElement(fo,Tj(Xj(Yj(_j(Zj(Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['new-todo']))),(bb(this.b),this.e)),Vg(Zl.prototype.pb,Zl,[this])),Vg($l.prototype.ob,$l,[this]))))};_.e='';var Uf=jh(148);Tg(149,148,{});var Rk;var Of=jh(149);Tg(150,149,eo,Yk);_.v=function(){if(this.d>=0){this.d=-2;t((J(),J(),I),new G(new bl(this)),Qn,null)}};_.q=lo;_.lb=vo;_.C=to;_.s=mo;_.w=uo;_.t=function(){var a;return fh(qf),qf.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.mb=function(){var b;try{return B((J(),J(),I),this.a,new Zk(this))}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){b=a;throw Fg(b)}else if(ld(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.d=0;var qf=jh(150);Tg(153,1,Kn,Zk);_.u=xo;var lf=jh(153);Tg(154,1,Pn,$k);_.A=function(){Pk(this.a)};var mf=jh(154);Tg(155,1,Pn,_k);_.A=function(){Wk(this.a,this.b)};var nf=jh(155);Tg(151,1,Sn,al);_.A=wo;var of=jh(151);Tg(152,1,Pn,bl);_.A=function(){Xk(this.a)};var pf=jh(152);Tg(165,38,{});_.eb=function(){cl(this)};_.tb=yo;_.fb=function(){sl(this,this.sb())};_.gb=function(){var a,b;b=this.sb();a=(bb(b.a),b.g);return $wnd.React.createElement('li',Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,[a?go:null,this.tb()?'editing':null])),$wnd.React.createElement('div',Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['view'])),$wnd.React.createElement(fo,Xj(Uj($j(Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['toggle'])),(xk(),ck)),a),Vg(cm.prototype.ob,cm,[b]))),$wnd.React.createElement('label',ak(new $wnd.Object,Vg(dm.prototype.qb,dm,[this,b])),(bb(b.b),b.i)),$wnd.React.createElement(ao,Sj(Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['destroy'])),Vg(em.prototype.qb,em,[b])))),$wnd.React.createElement(fo,Yj(Xj(Wj(Vj(Pj(Qj(new $wnd.Object,Vg(fm.prototype.B,fm,[this])),cd(Yc(me,1),Ln,2,6,['edit'])),(bb(this.a),this.i)),Vg(gm.prototype.nb,gm,[this,b])),Vg(bm.prototype.ob,bm,[this])),Vg(hm.prototype.pb,hm,[this,b]))))};_.j=false;var Wf=jh(165);Tg(166,165,{});_.kb=function(){var a;a=(cb(this.c),this.o.props['a']);if(!!a&&a.f<0){return true}return false};_.sb=function(){return this.o.props['a']};_.tb=yo;_.hb=function(a,b,c){return ll(this,a,b,c)};var jl;var Qf=jh(166);Tg(167,166,eo,tl);_.eb=function(){var b;try{A((J(),J(),I),new wl(this),Un)}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){b=a;throw Fg(b)}else if(ld(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.v=function(){if(this.f>=0){this.f=-2;t((J(),J(),I),new G(new ul(this)),Qn,null)}};_.q=lo;_.lb=vo;_.C=zo;_.sb=function(){return cb(this.c),this.o.props['a']};_.s=mo;_.w=Co;_.tb=function(){return T(this.d)};_.hb=function(b,c,d){var e;try{return t((J(),J(),I),new xl(this,b,c,d),75505664,null)}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){e=a;throw Fg(e)}else if(ld(a,4)){e=a;throw Fg(new th(e))}else throw Fg(a)}};_.t=function(){var a;return fh(Af),Af.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.mb=function(){var b;try{return B((J(),J(),I),this.b,new vl(this))}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){b=a;throw Fg(b)}else if(ld(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.f=0;var Af=jh(167);Tg(170,1,Pn,ul);_.A=function(){ol(this.a)};var rf=jh(170);Tg(171,1,Kn,vl);_.u=xo;var sf=jh(171);Tg(172,1,Pn,wl);_.A=function(){cl(this.a)};var tf=jh(172);Tg(173,1,Kn,xl);_.u=function(){return pl(this.a,this.d,this.c,this.b)};_.b=false;var uf=jh(173);Tg(174,1,Pn,yl);_.A=function(){ml(this.a,zm(this.b))};var vf=jh(174);Tg(175,1,Pn,zl);_.A=function(){sl(this.a,this.b);jn((tm(),sm),null)};var wf=jh(175);Tg(176,1,Pn,Al);_.A=function(){dl(this.a,this.b)};var xf=jh(176);Tg(168,1,Kn,Bl);_.u=function(){return ql(this.a)};var yf=jh(168);Tg(169,1,Sn,Cl);_.A=wo;var zf=jh(169);Tg(136,38,{});_.gb=function(){var a,b;return $wnd.React.createElement('div',null,$wnd.React.createElement('div',null,$wnd.React.createElement(ho,Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,[ho])),$wnd.React.createElement('h1',null,'todos'),_l(new am)),T((tm(),qm).c)?null:$wnd.React.createElement('section',Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,[ho])),$wnd.React.createElement(fo,Xj($j(Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['toggle-all'])),(xk(),ck)),Vg(mm.prototype.ob,mm,[]))),$wnd.React.createElement.apply(null,['ul',Pj(new $wnd.Object,cd(Yc(me,1),Ln,2,6,['todo-list']))].concat((a=$i(Zi(T(sm.c).U()),(b=new gi,b)),fi(a,bd(a.a.length)))))),T(qm.c)?null:Ll(new Ml)))};var Yf=jh(136);Tg(137,136,{});var Dl;var Sf=jh(137);Tg(138,137,eo,Gl);_.v=function(){if(this.c>=0){this.c=-2;t((J(),J(),I),new G(new Il(this)),Qn,null)}};_.q=lo;_.lb=vo;_.C=po;_.s=mo;_.w=Ao;_.t=function(){var a;return fh(Ef),Ef.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.mb=function(){var b;try{return B((J(),J(),I),this.a,new Jl(this))}catch(a){a=Eg(a);if(ld(a,6)||ld(a,7)){b=a;throw Fg(b)}else if(ld(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.c=0;var Ef=jh(138);Tg(139,1,Sn,Hl);_.A=wo;var Bf=jh(139);Tg(140,1,Pn,Il);_.A=function(){Kk(this.a)};var Cf=jh(140);Tg(141,1,Kn,Jl);_.u=xo;var Df=jh(141);Tg(232,$wnd.Function,{},Kl);_.qb=function(a){Ym((tm(),rm))};Tg(143,1,{},Ml);var Ff=jh(143);Tg(163,1,{},Ol);var Gf=jh(163);Tg(231,$wnd.Function,{},Pl);_.ib=function(a){return new Ql(a)};Tg(145,34,{},Ql);_.jb=function(){return new Dk};_.componentWillUnmount=Bo;var Jf=jh(145);Tg(242,$wnd.Function,{},Rl);_.ib=function(a){return new Sl(a)};Tg(164,34,{},Sl);_.jb=function(){return new Lk};_.componentWillUnmount=Bo;var Kf=jh(164);Tg(228,$wnd.Function,{},Tl);_.ib=function(a){return new Ul(a)};Tg(144,34,{},Ul);_.jb=function(){return new Yk};_.componentWillUnmount=Bo;var Nf=jh(144);Tg(233,$wnd.Function,{},Vl);_.ib=function(a){return new Wl(a)};Tg(147,34,{},Wl);_.jb=function(){return new tl};_.componentDidUpdate=function(a){Dj(this.a,a)};_.componentWillUnmount=Bo;_.shouldComponentUpdate=function(a){return Ej(this.a,a)};var Pf=jh(147);Tg(225,$wnd.Function,{},Xl);_.ib=function(a){return new Yl(a)};Tg(120,34,{},Yl);_.jb=function(){return new Gl};_.componentWillUnmount=Bo;var Rf=jh(120);Tg(229,$wnd.Function,{},Zl);_.pb=function(a){Qk(this.a,a)};Tg(230,$wnd.Function,{},$l);_.ob=function(a){Vk(this.a,a)};Tg(142,1,{},am);var Tf=jh(142);Tg(240,$wnd.Function,{},bm);_.ob=function(a){nl(this.a,a)};Tg(234,$wnd.Function,{},cm);_.ob=function(a){Dm(this.a)};Tg(236,$wnd.Function,{},dm);_.qb=function(a){el(this.a,this.b)};Tg(237,$wnd.Function,{},em);_.qb=function(a){il(this.a)};Tg(238,$wnd.Function,{},fm);_.B=function(a){fl(this.a,a)};Tg(239,$wnd.Function,{},gm);_.nb=function(a){hl(this.a,this.b)};Tg(241,$wnd.Function,{},hm);_.pb=function(a){gl(this.a,this.b,a)};Tg(146,1,{},lm);var Vf=jh(146);Tg(226,$wnd.Function,{},mm);_.ob=function(a){var b;b=a.target;an((tm(),rm),b.checked)};Tg(65,1,{},om);var Xf=jh(65);var pm,qm,rm,sm;Tg(49,1,{49:1});_.g=false;var Ag=jh(49);Tg(50,49,{11:1,24:1,50:1,49:1},Em);_.v=function(){xm(this)};_.q=function(a){return ym(this,a)};_.C=to;_.s=zo;_.w=Co;_.t=function(){var a;return fh(mg),mg.k+'@'+(a=this.e>>>0,a.toString(16))};_.e=0;_.f=0;var um=0;var mg=jh(50);Tg(177,1,Pn,Fm);_.A=function(){Bm(this.a)};var Zf=jh(177);Tg(178,1,Pn,Gm);_.A=function(){Cm(this.a)};var $f=jh(178);Tg(47,107,{47:1});var vg=jh(47);Tg(108,47,{11:1,24:1,47:1},Om);_.v=function(){if(this.g>=0){this.g=-2;t((J(),J(),I),new G(new Pm(this)),Qn,null)}};_.q=lo;_.C=Do;_.s=mo;_.w=function(){return this.g<0};_.t=function(){var a;return fh(gg),gg.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.g=0;var gg=jh(108);Tg(113,1,Pn,Pm);_.A=function(){Lm(this.a)};var _f=jh(113);Tg(114,1,Pn,Qm);_.A=function(){hc(this.a,this.b,true)};var ag=jh(114);Tg(109,1,Kn,Rm);_.u=function(){return Mm(this.a)};var bg=jh(109);Tg(115,1,Kn,Sm);_.u=function(){return Hm(this.a,this.c,this.b)};_.b=false;var cg=jh(115);Tg(110,1,Kn,Tm);_.u=function(){return vh(Kg(Xi(Km(this.a))))};var dg=jh(110);Tg(111,1,Kn,Um);_.u=function(){return vh(Kg(Xi(Yi(Km(this.a),new Bn))))};var eg=jh(111);Tg(112,1,Kn,Vm);_.u=function(){return Nm(this.a)};var fg=jh(112);Tg(85,1,{});var zg=jh(85);Tg(86,85,eo,bn);_.v=function(){if(this.b>=0){this.b=-2;t((J(),J(),I),new G(new en(this)),Qn,null)}};_.q=lo;_.C=ko;_.s=mo;_.w=function(){return this.b<0};_.t=function(){var a;return fh(lg),lg.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.b=0;var lg=jh(86);Tg(89,1,Pn,cn);_.A=function(){wm(this.b,this.a)};var hg=jh(89);Tg(90,1,Pn,dn);_.A=function(){Zm(this.a)};var ig=jh(90);Tg(87,1,Pn,en);_.A=function(){nc(this.a.a)};var jg=jh(87);Tg(88,1,Pn,fn);_.A=function(){$m(this.a,this.b)};_.b=false;var kg=jh(88);Tg(91,1,{});var Cg=jh(91);Tg(92,91,eo,pn);_.v=function(){if(this.i>=0){this.i=-2;t((J(),J(),I),new G(new qn(this)),Qn,null)}};_.q=lo;_.C=function(){return this.g};_.s=mo;_.w=function(){return this.i<0};_.t=function(){var a;return fh(sg),sg.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.i=0;var sg=jh(92);Tg(97,1,Pn,qn);_.A=function(){ln(this.a)};var ng=jh(97);Tg(93,1,Kn,rn);_.u=function(){var a;return a=Wb(this.a.j),Bh(jo,a)||Bh(go,a)||Bh('',a)?Bh(jo,a)?(yn(),vn):Bh(go,a)?(yn(),xn):(yn(),wn):(yn(),wn)};var og=jh(93);Tg(94,1,Kn,sn);_.u=function(){return mn(this.a)};var pg=jh(94);Tg(95,1,Sn,tn);_.A=function(){nn(this.a)};var qg=jh(95);Tg(96,1,Sn,un);_.A=function(){on(this.a)};var rg=jh(96);Tg(37,36,{3:1,32:1,36:1,37:1},zn);var vn,wn,xn;var tg=kh(37,An);Tg(81,1,{},Bn);_.db=function(a){return !Am(a)};var ug=jh(81);Tg(83,1,{},Cn);_.db=function(a){return Am(a)};var wg=jh(83);Tg(84,1,{},Dn);_.B=function(a){Jm(this.a,a)};var xg=jh(84);Tg(82,1,{},En);_.B=function(a){Xm(this.a,a)};_.a=false;var yg=jh(82);Tg(73,1,{},Fn);_.db=function(a){return hn(this.a,a)};var Bg=jh(73);var Gn=(Dc(),Gc);var gwtOnLoad=gwtOnLoad=Og;Mg(Zg);Pg('permProps',[[]]);if (todomvc) todomvc.onScriptLoad(gwtOnLoad);})();