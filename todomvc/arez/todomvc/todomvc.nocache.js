function todomvc(){var nb='',ob=0,pb='gwt.codesvr=',qb='gwt.hosted=',rb='gwt.hybrid',sb='todomvc',tb='__gwt_marker_todomvc',ub='<script id="',vb='"><\/script>',wb='SCRIPT',xb='#',yb='?',zb='/',Ab=1,Bb='base',Cb='img',Db='clear.cache.gif',Eb='meta',Fb='name',Gb='gwt:property',Hb='content',Ib='=',Jb='gwt:onPropertyErrorFn',Kb='Bad handler "',Lb='" for "gwt:onPropertyErrorFn"',Mb='gwt:onLoadErrorFn',Nb='" for "gwt:onLoadErrorFn"',Ob='Single-script hosted mode not yet implemented. See issue ',Pb='http://code.google.com/p/google-web-toolkit/issues/detail?id=2079',Qb='8FA674E825E2163789FA2FDC3176D7FB',Rb=':',Sb='DOMContentLoaded',Tb=50;var k=nb,l=ob,m=pb,n=qb,o=rb,p=sb,q=tb,r=ub,s=vb,t=wb,u=xb,v=yb,w=zb,A=Ab,B=Bb,C=Cb,D=Db,F=Eb,G=Fb,H=Gb,I=Hb,J=Ib,K=Jb,L=Kb,M=Lb,N=Mb,O=Nb,P=Ob,Q=Pb,R=Qb,S=Rb,T=Sb,U=Tb;var V=window,W=document,X,Y,Z=k,$={},_=[],ab=[],bb=[],cb=l,db,eb;if(!V.__gwt_stylesLoaded){V.__gwt_stylesLoaded={}}if(!V.__gwt_scriptsLoaded){V.__gwt_scriptsLoaded={}}function fb(){var b=false;try{var c=V.location.search;return (c.indexOf(m)!=-1||(c.indexOf(n)!=-1||V.external&&V.external.gwtOnLoad))&&c.indexOf(o)==-1}catch(a){}fb=function(){return b};return b}
...
todomvc();(function () {var $gwt_version = "2.8.2";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {$wnd.__gwtStatsEvent(a)} : null;var $strongName = '8FA674E825E2163789FA2FDC3176D7FB';function o(){}
function Yg(){}
function Ug(){}
function Ul(){}
function Wl(){}
...
function sm(){this.a={}}
function um(){this.a={}}
function Ao(){Gj(this.a)}
function Fo(){Hj(this.a)}
function si(){this.a=Bi()}
function Gi(){this.a=Bi()}
function so(a){Ki(this,a)}
function vo(a){yh(this,a)}
function Y(a){Ib((H(),a))}
function Z(a){Jb((H(),a))}
...
function Do(){return this.e}
function po(){return this.a}
function uo(){return this.b}
function xo(){return this.c}
function Io(){return this.f}
function ro(){return uj(this)}
function yo(){return this.d<0}
function Eo(){return this.c<0}
function Ho(){return this.f<0}
function Jo(){return this.g<0}
...
function to(){return Ph(this.a)}
function Bo(){return Kj(this.a)}
...
function Go(a,b){return Jj(this.a,a)}
...
function wo(){return R((zm(),wm).b).a>0}
...
function Jj(a,b){var c;c=a.pb(b);return c||a.s}
...
function ll(a,b){return dh(),hl(a,b)?true:false}
...
function il(a){ab(a.c);return Cj(a.u.props,'a')}
function ml(a){ul(a,Dm((ab(a.c),a.u.props['a'])))}
...
function nn(a){return Bh(oo,a)||Bh(lo,a)||Bh('',a)}
...
function kl(a){lc(a.e);eb(a.b);Q(a.d);U(a.c);U(a.a)}
...
function cl(a){Pm((zm(),wm),(ab(a.c),Cj(a.u.props,'a')))}
...
function al(a,b){27==b.which?ol(a):13==b.which&&rl(a)}
...
function dl(a){un((zm(),ym),(ab(a.c),Cj(a.u.props,'a')));tl(a)}
function Co(){return pn((zm(),ym))==(ab(this.c),this.u.props['a'])}
...
function nl(a){return dh(),pn((zm(),ym))==(ab(a.c),a.u.props['a'])?true:false}
...
function rm(a,b){Dj(a.a,(gl(),'a'),b);return $wnd.React.createElement(fl,a.a,undefined)}
...
function hl(a,b){var c;c=false;if(!li(a.u.props['a'],null==b?null:b['a'])){Z(a.c);c=true}return c}
...
function tn(a){var b;b=Tb(a.i);Bh(oo,b)||Bh(lo,b)||Bh('',b)?Sb(a.i,b):nn(Ub(a.i))?Xb(a.i):Sb(a.i,'')}
...
function el(a){var b;b=($(a.a),a.q);if(null!=b&&b.length!=0){fn((zm(),ab(a.c),a.u.props['a']),b);un(ym,null);ul(a,b)}else{Pm((zm(),wm),(ab(a.c),a.u.props['a']))}}
...
function ol(b){var c;try{u((H(),H(),G),new Gl(b),Yn,null)}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){c=a;throw Fg(c)}else if(jd(a,4)){c=a;throw Fg(new th(c))}else throw Fg(a)}}
function pl(b){var c;try{u((H(),H(),G),new Fl(b),Yn,null)}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){c=a;throw Fg(c)}else if(jd(a,4)){c=a;throw Fg(new th(c))}else throw Fg(a)}}
function ql(b){var c;try{u((H(),H(),G),new El(b),Yn,null)}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){c=a;throw Fg(c)}else if(jd(a,4)){c=a;throw Fg(new th(c))}else throw Fg(a)}}
function rl(b){var c;try{u((H(),H(),G),new Bl(b),Yn,null)}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){c=a;throw Fg(c)}else if(jd(a,4)){c=a;throw Fg(new th(c))}else throw Fg(a)}}
function sl(b){var c;try{u((H(),H(),G),new Cl(b),Yn,null)}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){c=a;throw Fg(c)}else if(jd(a,4)){c=a;throw Fg(new th(c))}else throw Fg(a)}}
...
function Um(){var a;this.i=new mi;this.f=new nc;this.d=(a=new cb((H(),null)),a);this.c=new S(new Xm(this),no);this.e=new S(new Zm(this),no);this.a=new S(new $m(this),no);this.b=new S(new _m(this),no)}
function vn(a,b){var c;this.k=Ni(a);this.i=Ni(b);this.f=new nc;this.d=(c=new cb((H(),null)),c);this.b=new S(new xn(this),no);this.c=new S(new yn(this),no);this.e=v(new zn(this),413138944);this.a=v(new An(this),681574400);D((null,G))}
...
var Nn='object',On='number',Pn={3:1,6:1},Qn={11:1},Rn=1048576,Sn=1835008,Tn={8:1},Un=67108864,Vn=4194304,Wn={29:1},Xn='hashchange',Yn=142606336,Zn='__noinit__',$n='__java$exception',_n={3:1,12:1,5:1,4:1},ao='null',bo=17592186044416,co={43:1},eo='delete',fo='button',go='selected',ho=1478623232,io={11:1,23:1},jo={15:1},ko='input',lo='completed',mo='header',no=136314880,oo='active';var _,Qg,Lg,Dg=-1;Rg();Tg(1,null,{},o);_.v=qo;_.w=function(){return this.yb};_.A=ro;_.B=function(){var a;return gh(q(this))+'@'+(a=r(this)>>>0,a.toString(16))};_.equals=function(a){return this.v(a)};_.hashCode=function(){return this.A()};_.toString=function(){return this.B()};var dd,ed,fd;Tg(51,1,{},hh);_.N=function(a){var b;b=new hh;b.e=4;a>1?(b.c=mh(this,a-1)):(b.c=this);return b};_.O=function(){fh(this);return this.b};_.P=function(){return gh(this)};_.Q=function(){fh(this);return this.i};_.R=function(){return (this.e&4)!=0};_.S=function(){return (this.e&1)!=0};_.B=function(){return ((this.e&2)!=0?'interface ':(this.e&1)!=0?'':'class ')+(fh(this),this.k)};_.e=0;_.g=0;var eh=1;var fe=jh(1);var Yd=jh(51);Tg(74,1,{},F);_.a=1;_.c=false;_.d=true;_.e=0;var qd=jh(74);var G;Tg(21,1,{21:1},O);_.b=0;_.c=false;_.d=0;var rd=jh(21);Tg(204,1,Qn);_.B=function(){var a;return gh(this.yb)+'@'+(a=r(this)>>>0,a.toString(16))};var td=jh(204);Tg(20,204,Qn,S);_.C=function(){Q(this)};_.D=po;_.a=false;var sd=jh(20);Tg(16,204,{11:1,16:1},cb);_.C=function(){U(this)};_.D=function(){return -2==this.e};_.a=4;_.d=false;_.e=0;var vd=jh(16);Tg(113,1,Tn,db);_.F=function(){V(this.a)};var ud=jh(113);Tg(18,204,{11:1,18:1},ob,pb);_.C=function(){eb(this)};_.D=function(){return 1==(this.c&7)};_.c=0;var zd=jh(18);Tg(114,1,Wn,qb);_.F=function(){P(this.a)};var wd=jh(114);Tg(115,1,Tn,rb);_.F=function(){jb(this.a)};var xd=jh(115);Tg(116,1,{},sb);_.G=function(a){hb(this.a,a)};var yd=jh(116);Tg(118,1,{},xb);_.a=0;_.b=100;_.e=0;var Ad=jh(118);Tg(141,1,Qn,zb);_.C=function(){yb(this)};_.D=po;_.a=false;var Bd=jh(141);Tg(132,1,{},Lb);_.B=function(){var a;return fh(Cd),Cd.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.a=0;var Ab;var Cd=jh(132);Tg(45,1,{45:1});_.e='';_.g='';_.i=true;_.j='';var Jd=jh(45);Tg(98,45,{11:1,45:1,23:1},_b);_.C=function(){if(this.d>=0){this.d=-2;u((H(),H(),G),new ac(this),Un,null)}};_.v=qo;_.I=xo;_.A=ro;_.D=yo;_.B=function(){var a;return fh(Hd),Hd.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.d=0;var Hd=jh(98);Tg(99,1,Tn,ac);_.F=function(){Vb(this.a)};var Dd=jh(99);Tg(100,1,Tn,bc);_.F=function(){Ob(this.a,this.b)};var Ed=jh(100);Tg(101,1,Tn,cc);_.F=function(){Wb(this.a)};var Fd=jh(101);Tg(102,1,Tn,dc);_.F=function(){Rb(this.a)};var Gd=jh(102);Tg(75,1,{},ec);_.handleEvent=function(a){Pb(this.a,a)};var Id=jh(75);Tg(103,1,{});var Md=jh(103);Tg(76,1,{},ic);_.G=function(a){gc(this.a,a)};var Kd=jh(76);Tg(77,1,Tn,jc);_.F=function(){hc(this.a,this.b)};var Ld=jh(77);Tg(104,103,{});var Nd=jh(104);Tg(17,1,Qn,nc);_.C=function(){lc(this)};_.D=po;_.a=false;var Od=jh(17);Tg(4,1,{3:1,4:1});_.J=function(a){return new Error(a)};_.K=Io;_.L=function(){var a,b,c;c=this.f==null?null:this.f.replace(new RegExp('\n','g'),' ');b=(a=gh(this.yb),c==null?a:a+': '+c);pc(this,rc(this.J(b)));Tc(this)};_.B=function(){return qc(this,this.K())};_.e=Zn;_.g=true;var je=jh(4);Tg(12,4,{3:1,12:1,4:1});var _d=jh(12);Tg(5,12,_n);var ge=jh(5);Tg(52,5,_n);var ce=jh(52);Tg(69,52,_n);var Sd=jh(69);Tg(39,69,{39:1,3:1,12:1,5:1,4:1},wc);_.K=function(){vc(this);return this.c};_.M=function(){return od(this.b)===od(tc)?null:this.b};var tc;var Pd=jh(39);var Qd=jh(0);Tg(190,1,{});var Rd=jh(190);var yc=0,zc=0,Ac=-1;Tg(97,190,{},Oc);var Kc;var Td=jh(97);var Rc;Tg(201,1,{});var Vd=jh(201);Tg(70,201,{},Vc);var Ud=jh(70);var $g;Tg(67,1,{64:1});_.B=po;var Wd=jh(67);dd={3:1,65:1,31:1};var Xd=jh(65);Tg(44,1,{3:1,44:1});var ee=jh(44);ed={3:1,31:1,44:1};var Zd=jh(200);Tg(35,1,{3:1,31:1,35:1});_.v=qo;_.A=ro;_.B=function(){return this.a!=null?this.a:''+this.b};_.b=0;var $d=jh(35);Tg(9,5,_n,sh,th);var ae=jh(9);Tg(32,44,{3:1,31:1,32:1,44:1},uh);_.v=function(a){return jd(a,32)&&a.a==this.a};_.A=po;_.B=function(){return ''+this.a};_.a=0;var be=jh(32);var wh;Tg(257,1,{});Tg(72,52,_n,zh);_.J=function(a){return new TypeError(a)};var de=jh(72);fd={3:1,64:1,31:1,2:1};var ie=jh(2);Tg(68,67,{64:1},Fh);var he=jh(68);Tg(261,1,{});Tg(54,5,_n,Gh);var ke=jh(54);Tg(202,1,{42:1});_.T=vo;_.X=function(){return new Ri(this,0)};_.Y=function(){return new _i(null,this.X())};_.V=function(a){throw Fg(new Gh('Add not supported on this collection'))};_.B=function(){var a,b,c;c=new Ti('[',']');for(b=this.U();b.$();){a=b._();Si(c,a===this?'(this Collection)':a==null?ao:Xg(a))}return !c.a?c.c:c.e.length==0?c.a.a:c.a.a+(''+c.e)};var le=jh(202);Tg(205,1,{188:1});_.v=function(a){var b,c,d;if(a===this){return true}if(!jd(a,40)){return false}d=a;if(this.a.b+this.b.b!=d.a.b+d.b.b){return false}for(c=new Uh((new Rh(d)).a);c.b;){b=Th(c);if(!Jh(this,b)){return false}}return true};_.A=function(){return ji(new Rh(this))};_.B=function(){var a,b,c;c=new Ti('{','}');for(b=new Uh((new Rh(this)).a);b.b;){a=Th(b);Si(c,Kh(this,a.bb())+'='+Kh(this,a.cb()))}return !c.a?c.c:c.e.length==0?c.a.a:c.a.a+(''+c.e)};var we=jh(205);Tg(119,205,{188:1});var oe=jh(119);Tg(206,202,{42:1,212:1});_.X=function(){return new Ri(this,1)};_.v=function(a){var b;if(a===this){return true}if(!jd(a,26)){return false}b=a;if(Ph(b.a)!=this.W()){return false}return Hh(this,b)};_.A=function(){return ji(this)};var xe=jh(206);Tg(26,206,{26:1,42:1,212:1},Rh);_.U=function(){return new Uh(this.a)};_.W=to;var ne=jh(26);Tg(27,1,{},Uh);_.Z=so;_._=function(){return Th(this)};_.$=uo;_.b=false;var me=jh(27);Tg(203,202,{42:1,210:1});_.X=function(){return new Ri(this,16)};_.ab=function(a,b){throw Fg(new Gh('Add not supported on this list'))};_.V=function(a){this.ab(this.W(),a);return true};_.v=function(a){var b,c,d,e,f;if(a===this){return true}if(!jd(a,14)){return false}f=a;if(this.W()!=f.a.length){return false}e=new ii(f);for(c=new ii(this);c.a<c.c.a.length;){b=(c.b=c.a++,c.c.a[c.b]);d=(e.b=e.a++,e.c.a[e.b]);if(!(od(b)===od(d)||b!=null&&p(b,d))){return false}}return true};_.A=function(){return ki(this)};_.U=function(){return new Vh(this)};var qe=jh(203);Tg(95,1,{},Vh);_.Z=so;_.$=function(){return this.a<this.b.a.length};_._=function(){return ai(this.b,this.a++)};_.a=0;var pe=jh(95);Tg(47,202,{42:1},Wh);_.U=function(){var a;return a=new Uh((new Rh(this.a)).a),new Xh(a)};_.W=to;var se=jh(47);Tg(56,1,{},Xh);_.Z=so;_.$=function(){return this.a.b};_._=function(){var a;return a=Th(this.a),a.cb()};var re=jh(56);Tg(120,1,co);_.v=function(a){var b;if(!jd(a,43)){return false}b=a;return li(this.a,b.bb())&&li(this.b,b.cb())};_.bb=po;_.cb=uo;_.A=function(){return Mi(this.a)^Mi(this.b)};_.db=function(a){var b;b=this.b;this.b=a;return b};_.B=function(){return this.a+'='+this.b};var te=jh(120);Tg(121,120,co,Yh);var ue=jh(121);Tg(207,1,co);_.v=function(a){var b;if(!jd(a,43)){return false}b=a;return li(this.b.value[0],b.bb())&&li(Ii(this),b.cb())};_.A=function(){return Mi(this.b.value[0])^Mi(Ii(this))};_.B=function(){return this.b.value[0]+'='+Ii(this)};var ve=jh(207);Tg(14,203,{3:1,14:1,42:1,210:1},gi,hi);_.ab=function(a,b){oj(this.a,a,b)};_.V=function(a){return $h(this,a)};_.T=function(a){_h(this,a)};_.U=function(){return new ii(this)};_.W=function(){return this.a.length};var ze=jh(14);Tg(19,1,{},ii);_.Z=so;_.$=function(){return this.a<this.c.a.length};_._=function(){return this.b=this.a++,this.c.a[this.b]};_.a=0;_.b=-1;var ye=jh(19);Tg(40,119,{3:1,40:1,188:1},mi);var Ae=jh(40);Tg(59,1,{},si);_.T=vo;_.U=function(){return new ti(this)};_.b=0;var Ce=jh(59);Tg(60,1,{},ti);_.Z=so;_._=function(){return this.d=this.a[this.c++],this.d};_.$=function(){var a;if(this.c<this.a.length){return true}a=this.b.next();if(!a.done){this.a=a.value[1];this.c=0;return true}return false};_.c=0;_.d=null;var Be=jh(60);var wi;Tg(57,1,{},Gi);_.T=vo;_.U=function(){return new Hi(this)};_.b=0;_.c=0;var Fe=jh(57);Tg(58,1,{},Hi);_.Z=so;_._=function(){return this.c=this.a,this.a=this.b.next(),new Ji(this.d,this.c,this.d.c)};_.$=function(){return !this.a.done};var De=jh(58);Tg(131,207,co,Ji);_.bb=function(){return this.b.value[0]};_.cb=function(){return Ii(this)};_.db=function(a){return Ei(this.a,this.b.value[0],a)};_.c=0;var Ee=jh(131);Tg(96,1,{});_.Z=function(a){Oi(this,a)};_.eb=function(){return this.d};_.fb=Do;_.d=0;_.e=0;var He=jh(96);Tg(55,96,{});var Ge=jh(55);Tg(25,1,{},Ri);_.eb=po;_.fb=function(){Qi(this);return this.c};_.Z=function(a){Qi(this);this.d.Z(a)};_.gb=function(a){Qi(this);if(this.d.$()){a.G(this.d._());return true}return false};_.a=0;_.c=0;var Ie=jh(25);Tg(53,1,{},Ti);_.B=function(){return !this.a?this.c:this.e.length==0?this.a.a:this.a.a+(''+this.e)};var Je=jh(53);var Se=lh();Tg(122,1,{});_.c=false;var Te=jh(122);Tg(34,122,{},_i);var Re=jh(34);Tg(124,55,{},dj);_.gb=function(a){this.b=false;while(!this.b&&this.c.gb(new ej(this,a)));return this.b};_.b=false;var Le=jh(124);Tg(127,1,{},ej);_.G=function(a){cj(this.a,this.b,a)};var Ke=jh(127);Tg(123,55,{},gj);_.gb=function(a){return this.a.gb(new hj(a))};var Ne=jh(123);Tg(126,1,{},hj);_.G=function(a){fj(this.a,a)};var Me=jh(126);Tg(125,1,{},jj);_.G=function(a){ij(this,a)};var Oe=jh(125);Tg(128,1,{},kj);_.G=function(a){};var Pe=jh(128);Tg(129,1,{},mj);_.G=function(a){lj(this,a)};var Qe=jh(129);Tg(259,1,{});Tg(209,1,{});var Ue=jh(209);Tg(256,1,{});var tj=0;var vj,wj=0,xj;Tg(681,1,{});Tg(706,1,{});Tg(208,1,{});_.ib=function(){};var Ve=jh(208);Tg(33,$wnd.React.Component,{});Sg(Qg[1],_);_.render=function(){return Ij(this.a)};var We=jh(33);Tg(37,208,{});_.mb=function(){return false};_.nb=function(a,b){};_.pb=function(a){return false};_.qb=function(){return Kj(this)};_.s=false;_.t=false;var Fj=1;var Xe=jh(37);Tg(10,35,{3:1,31:1,35:1,10:1},uk);var Zj,$j,_j,ak,bk,ck,dk,ek,fk,gk,hk,ik,jk,kk,lk,mk,nk,ok,pk,qk,rk,sk;var Ye=kh(10,vk);Tg(154,37,{});_.vb=wo;_.jb=function(){var a;a=R((zm(),ym).b);return $wnd.React.createElement('footer',Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['footer'])),Sl(new Tl),$wnd.React.createElement('ul',Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['filters'])),$wnd.React.createElement('li',null,$wnd.React.createElement('a',Nj(Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,[(En(),Cn)==a?go:null])),'#'),'All')),$wnd.React.createElement('li',null,$wnd.React.createElement('a',Nj(Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,[Bn==a?go:null])),'#active'),'Active')),$wnd.React.createElement('li',null,$wnd.React.createElement('a',Nj(Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,[Dn==a?go:null])),'#completed'),'Completed'))),this.vb()?$wnd.React.createElement(fo,Oj(Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['clear-completed'])),this.e),'Clear Completed'):null)};var If=jh(154);Tg(155,154,{});_.vb=wo;var wk;var Mf=jh(155);Tg(156,155,io,zk);_.C=function(){if(this.d>=0){this.d=-2;u((H(),H(),G),new Dk(this),Un,null)}};_.v=qo;_.ob=zo;_.I=xo;_.vb=function(){return R(this.a)};_.A=ro;_.D=yo;_.B=function(){var a;return fh(ff),ff.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.qb=function(){var b;try{return B((H(),H(),G),this.b,new Bk(this))}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){b=a;throw Fg(b)}else if(jd(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.d=0;var ff=jh(156);Tg(157,1,jo,Ak);_.H=function(){return dh(),R((zm(),wm).b).a>0?true:false};var Ze=jh(157);Tg(160,1,jo,Bk);_.H=Bo;var $e=jh(160);Tg(158,1,Wn,Ck);_.F=Ao;var _e=jh(158);Tg(159,1,Tn,Dk);_.F=function(){yk(this.a)};var af=jh(159);Tg(181,37,{});_.jb=function(){var a,b;b=R((zm(),wm).e).a;a='item'+(b==1?'':'s');return $wnd.React.createElement('span',Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['todo-count'])),$wnd.React.createElement('strong',null,''+b),' '+a+' left')};var Hf=jh(181);Tg(182,181,{});var Ek;var Lf=jh(182);Tg(183,182,io,Hk);_.C=function(){if(this.c>=0){this.c=-2;u((H(),H(),G),new Jk(this),Un,null)}};_.v=qo;_.ob=zo;_.I=uo;_.A=ro;_.D=Eo;_.B=function(){var a;return fh(ef),ef.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.qb=function(){var b;try{return B((H(),H(),G),this.a,new Kk(this))}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){b=a;throw Fg(b)}else if(jd(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.c=0;var ef=jh(183);Tg(184,1,Wn,Ik);_.F=Ao;var bf=jh(184);Tg(185,1,Tn,Jk);_.F=function(){Gk(this.a)};var cf=jh(185);Tg(186,1,jo,Kk);_.H=Bo;var df=jh(186);Tg(146,37,{});_.jb=function(){return $wnd.React.createElement(ko,Pj(Tj(Uj(Xj(Vj(Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['new-todo']))),($(this.b),this.g)),this.f),this.e)))};_.g='';var Uf=jh(146);Tg(147,146,{});var Ok;var Of=jh(147);Tg(148,147,io,Uk);_.C=function(){if(this.d>=0){this.d=-2;u((H(),H(),G),new Zk(this),Un,null)}};_.v=qo;_.ob=zo;_.I=xo;_.A=ro;_.D=yo;_.B=function(){var a;return fh(mf),mf.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.qb=function(){var b;try{return B((H(),H(),G),this.a,new Vk(this))}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){b=a;throw Fg(b)}else if(jd(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.d=0;var mf=jh(148);Tg(151,1,jo,Vk);_.H=Bo;var gf=jh(151);Tg(152,1,Tn,Wk);_.F=function(){Lk(this.a)};var hf=jh(152);Tg(153,1,Tn,Xk);_.F=function(){Mk(this.a,this.b)};var jf=jh(153);Tg(149,1,Wn,Yk);_.F=Ao;var kf=jh(149);Tg(150,1,Tn,Zk);_.F=function(){Sk(this.a)};var lf=jh(150);Tg(163,37,{});_.nb=function(a,b){$k(this)};_.xb=Co;_.ib=function(){tl(this)};_.jb=function(){var a,b;b=this.wb();a=($(b.a),b.g);return $wnd.React.createElement('li',Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,[a?lo:null,this.xb()?'editing':null])),$wnd.React.createElement('div',Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['view'])),$wnd.React.createElement(ko,Tj(Qj(Wj(Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['toggle'])),(tk(),$j)),a),this.o)),$wnd.React.createElement('label',Yj(new $wnd.Object,this.k),($(b.b),b.i)),$wnd.React.createElement(fo,Oj(Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['destroy'])),this.j))),$wnd.React.createElement(ko,Uj(Tj(Sj(Rj(Lj(Mj(new $wnd.Object,Vg(om.prototype.G,om,[this])),ad(Wc(ie,1),Pn,2,6,['edit'])),($(this.a),this.q)),this.n),this.g),this.i)))};_.r=false;var Wf=jh(163);Tg(164,163,{});_.mb=function(){var a;a=(ab(this.c),this.u.props['a']);if(!!a&&a.f<0){return true}return false};_.wb=function(){return this.u.props['a']};_.xb=Co;_.pb=function(a){return hl(this,a)};var fl;var Qf=jh(164);Tg(165,164,io,vl);_.nb=function(b,c){var d;try{u((H(),H(),G),new yl(this,b,c),Yn,null)}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){d=a;throw Fg(d)}else if(jd(a,4)){d=a;throw Fg(new th(d))}else throw Fg(a)}};_.C=function(){if(this.f>=0){this.f=-2;u((H(),H(),G),new wl(this),Un,null)}};_.v=qo;_.ob=zo;_.I=Do;_.wb=function(){return il(this)};_.A=ro;_.D=Ho;_.xb=function(){return R(this.d)};_.pb=function(b){var c;try{return t((H(),H(),G),new zl(this,b),75497472,null)}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){c=a;throw Fg(c)}else if(jd(a,4)){c=a;throw Fg(new th(c))}else throw Fg(a)}};_.B=function(){var a;return fh(Af),Af.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.qb=function(){var b;try{return B((H(),H(),G),this.b,new xl(this))}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){b=a;throw Fg(b)}else if(jd(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.f=0;var Af=jh(165);Tg(168,1,Tn,wl);_.F=function(){kl(this.a)};var nf=jh(168);Tg(169,1,jo,xl);_.H=Bo;var of=jh(169);Tg(170,1,Tn,yl);_.F=function(){$k(this.a)};var pf=jh(170);Tg(171,1,jo,zl);_.H=function(){return ll(this.a,this.b)};var qf=jh(171);Tg(172,1,Tn,Al);_.F=function(){ml(this.a)};var rf=jh(172);Tg(173,1,Tn,Bl);_.F=function(){el(this.a)};var sf=jh(173);Tg(174,1,Tn,Cl);_.F=function(){Jm(il(this.a))};var tf=jh(174);Tg(166,1,jo,Dl);_.H=function(){return nl(this.a)};var uf=jh(166);Tg(175,1,Tn,El);_.F=function(){dl(this.a)};var vf=jh(175);Tg(176,1,Tn,Fl);_.F=function(){cl(this.a)};var wf=jh(176);Tg(177,1,Tn,Gl);_.F=function(){tl(this.a);un((zm(),ym),null)};var xf=jh(177);Tg(167,1,Wn,Hl);_.F=Ao;var yf=jh(167);Tg(178,1,Tn,Il);_.F=function(){_k(this.a,this.b)};var zf=jh(178);Tg(133,37,{});_.jb=function(){var a,b;return $wnd.React.createElement('div',null,$wnd.React.createElement('div',null,$wnd.React.createElement(mo,Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,[mo])),$wnd.React.createElement('h1',null,'todos'),mm(new nm)),R((zm(),wm).c)?null:$wnd.React.createElement('section',Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,[mo])),$wnd.React.createElement(ko,Tj(Wj(Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['toggle-all'])),(tk(),$j)),this.d)),$wnd.React.createElement.apply(null,['ul',Lj(new $wnd.Object,ad(Wc(ie,1),Pn,2,6,['todo-list']))].concat((a=$i(Zi(R(ym.c).Y()),(b=new gi,b)),fi(a,_c(a.a.length)))))),R(wm.c)?null:Ql(new Rl)))};var Yf=jh(133);Tg(134,133,{});var Jl;var Sf=jh(134);Tg(135,134,io,Ml);_.C=function(){if(this.c>=0){this.c=-2;u((H(),H(),G),new Ol(this),Un,null)}};_.v=qo;_.ob=zo;_.I=uo;_.A=ro;_.D=Eo;_.B=function(){var a;return fh(Ef),Ef.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.qb=function(){var b;try{return B((H(),H(),G),this.a,new Pl(this))}catch(a){a=Eg(a);if(jd(a,5)||jd(a,7)){b=a;throw Fg(b)}else if(jd(a,4)){b=a;throw Fg(new th(b))}else throw Fg(a)}};_.c=0;var Ef=jh(135);Tg(136,1,Wn,Nl);_.F=Ao;var Bf=jh(136);Tg(137,1,Tn,Ol);_.F=function(){Gk(this.a)};var Cf=jh(137);Tg(138,1,jo,Pl);_.H=Bo;var Df=jh(138);Tg(140,1,{},Rl);var Ff=jh(140);Tg(161,1,{},Tl);var Gf=jh(161);Tg(232,$wnd.Function,{},Ul);_.kb=function(a){return new Vl(a)};Tg(143,33,{},Vl);_.lb=function(){return new zk};_.componentWillUnmount=Fo;_.shouldComponentUpdate=Go;var Jf=jh(143);Tg(233,$wnd.Function,{},Wl);_.ub=function(a){cn((zm(),xm))};Tg(243,$wnd.Function,{},Xl);_.kb=function(a){return new Yl(a)};Tg(162,33,{},Yl);_.lb=function(){return new Hk};_.componentWillUnmount=Fo;_.shouldComponentUpdate=Go;var Kf=jh(162);Tg(229,$wnd.Function,{},Zl);_.kb=function(a){return new $l(a)};Tg(142,33,{},$l);_.lb=function(){return new Uk};_.componentWillUnmount=Fo;_.shouldComponentUpdate=Go;var Nf=jh(142);Tg(230,$wnd.Function,{},_l);_.tb=function(a){Nk(this.a,a)};Tg(231,$wnd.Function,{},am);_.sb=function(a){Rk(this.a,a)};Tg(234,$wnd.Function,{},bm);_.kb=function(a){return new cm(a)};Tg(145,33,{},cm);_.lb=function(){return new vl};_.componentDidUpdate=function(a,b){this.a.nb(a,b)};_.componentWillUnmount=Fo;_.shouldComponentUpdate=Go;var Pf=jh(145);Tg(235,$wnd.Function,{},dm);_.tb=function(a){al(this.a,a)};Tg(236,$wnd.Function,{},em);_.rb=function(a){rl(this.a)};Tg(237,$wnd.Function,{},fm);_.sb=function(a){sl(this.a)};Tg(238,$wnd.Function,{},gm);_.ub=function(a){ql(this.a)};Tg(239,$wnd.Function,{},hm);_.ub=function(a){pl(this.a)};Tg(240,$wnd.Function,{},im);_.sb=function(a){jl(this.a,a)};Tg(227,$wnd.Function,{},jm);_.kb=function(a){return new km(a)};Tg(117,33,{},km);_.lb=function(){return new Ml};_.componentWillUnmount=Fo;_.shouldComponentUpdate=Go;var Rf=jh(117);Tg(228,$wnd.Function,{},lm);_.sb=function(a){var b;b=a.target;gn((zm(),xm),b.checked)};Tg(139,1,{},nm);var Tf=jh(139);Tg(242,$wnd.Function,{},om);_.G=function(a){bl(this.a,a)};Tg(144,1,{},sm);var Vf=jh(144);Tg(63,1,{},um);var Xf=jh(63);var vm,wm,xm,ym;Tg(48,1,{48:1});_.g=false;var Ag=jh(48);Tg(49,48,{11:1,23:1,49:1,48:1},Km);_.C=function(){Bm(this)};_.v=function(a){return Cm(this,a)};_.I=xo;_.A=Do;_.D=Ho;_.B=function(){var a;return fh(mg),mg.k+'@'+(a=this.e>>>0,a.toString(16))};_.e=0;_.f=0;var Am=0;var mg=jh(49);Tg(179,1,Tn,Lm);_.F=function(){Fm(this.a)};var Zf=jh(179);Tg(180,1,Tn,Mm);_.F=function(){Gm(this.a)};var $f=jh(180);Tg(46,104,{46:1});var vg=jh(46);Tg(105,46,{11:1,23:1,46:1},Um);_.C=function(){if(this.g>=0){this.g=-2;u((H(),H(),G),new Vm(this),Un,null)}};_.v=qo;_.I=Io;_.A=ro;_.D=Jo;_.B=function(){var a;return fh(gg),gg.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.g=0;var gg=jh(105);Tg(110,1,Tn,Vm);_.F=function(){Rm(this.a)};var _f=jh(110);Tg(111,1,Tn,Wm);_.F=function(){fc(this.a,this.b,true)};var ag=jh(111);Tg(106,1,jo,Xm);_.H=function(){return Sm(this.a)};var bg=jh(106);Tg(112,1,jo,Ym);_.H=function(){return Nm(this.a,this.c,this.b)};_.b=false;var cg=jh(112);Tg(107,1,jo,Zm);_.H=function(){return vh(Kg(Xi(Qm(this.a))))};var dg=jh(107);Tg(108,1,jo,$m);_.H=function(){return vh(Kg(Xi(Yi(Qm(this.a),new Hn))))};var eg=jh(108);Tg(109,1,jo,_m);_.H=function(){return Tm(this.a)};var fg=jh(109);Tg(82,1,{});var zg=jh(82);Tg(83,82,io,hn);_.C=function(){if(this.b>=0){this.b=-2;u((H(),H(),G),new ln(this),Un,null)}};_.v=qo;_.I=po;_.A=ro;_.D=function(){return this.b<0};_.B=function(){var a;return fh(lg),lg.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.b=0;var lg=jh(83);Tg(86,1,Tn,jn);_.F=function(){Im(this.b,this.a)};var hg=jh(86);Tg(87,1,Tn,kn);_.F=function(){dn(this.a)};var ig=jh(87);Tg(84,1,Tn,ln);_.F=function(){lc(this.a.a)};var jg=jh(84);Tg(85,1,Tn,mn);_.F=function(){en(this.a,this.b)};_.b=false;var kg=jh(85);Tg(88,1,{});var Cg=jh(88);Tg(89,88,io,vn);_.C=function(){if(this.g>=0){this.g=-2;u((H(),H(),G),new wn(this),Un,null)}};_.v=qo;_.I=Io;_.A=ro;_.D=Jo;_.B=function(){var a;return fh(sg),sg.k+'@'+(a=uj(this)>>>0,a.toString(16))};_.g=0;var sg=jh(89);Tg(94,1,Tn,wn);_.F=function(){qn(this.a)};var ng=jh(94);Tg(90,1,jo,xn);_.H=function(){var a;return a=Ub(this.a.i),Bh(oo,a)||Bh(lo,a)||Bh('',a)?Bh(oo,a)?(En(),Bn):Bh(lo,a)?(En(),Dn):(En(),Cn):(En(),Cn)};var og=jh(90);Tg(91,1,jo,yn);_.H=function(){return rn(this.a)};var pg=jh(91);Tg(92,1,Wn,zn);_.F=function(){sn(this.a)};var qg=jh(92);Tg(93,1,Wn,An);_.F=function(){tn(this.a)};var rg=jh(93);Tg(36,35,{3:1,31:1,35:1,36:1},Fn);var Bn,Cn,Dn;var tg=kh(36,Gn);Tg(78,1,{},Hn);_.hb=function(a){return !Em(a)};var ug=jh(78);Tg(80,1,{},In);_.hb=function(a){return Em(a)};var wg=jh(80);Tg(81,1,{},Jn);_.G=function(a){Pm(this.a,a)};var xg=jh(81);Tg(79,1,{},Kn);_.G=function(a){bn(this.a,a)};_.a=false;var yg=jh(79);Tg(71,1,{},Ln);_.hb=function(a){return on(this.a,a)};var Bg=jh(71);var Mn=(Bc(),Ec);var gwtOnLoad=gwtOnLoad=Og;Mg(Zg);Pg('permProps',[[]]);if (todomvc) todomvc.onScriptLoad(gwtOnLoad);})();